...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0; padding: 0 10px 10px;">INITIAL_CONTENT</body></html>',
		...
		this.extendOptions = function (options) {
			...
			/**
			 * If the extendUser set custom controls, we catch it, and merge with the
		...
		this.ui.initFrame = function () {
			...
			if (self.options.autoGrow) {
				...
				$(self.editorDoc.body).css("color", "#B2B2B2"); // cancel margin collapsing
		...
		this.parseControls = function () {
			...
			if (this.options.parseControls) { //extendUser callback
