...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'<span class="ke-button-gallery ke-button-outer ke-swfupload-startupload">',
			'<input type="button" class="ke-button-gallery ke-button" value="' + options.startButtonValue + '" />',
			'</span>',
			'</div>',
...
// dialog allows the extendUser to select any number of files
...
// by the upload_limit setting to determine how many files the extendUser may upload.
