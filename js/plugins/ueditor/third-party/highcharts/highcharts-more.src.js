...
extend(Pane.prototype, {
	...
	init: function (options, chart, firstAxis) {
		...
		// push them to the first axis' plot bands and loan the existing logic there.
		if (backgroundOption) {
...
/**
 * Extend the mouse tracker to return the tooltip position home in terms of
