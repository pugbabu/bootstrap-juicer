...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        var defaults = {
            containerWidth : 'auto',                   // fixed (px)
            containerHeight : 'auto',                  // fixed (px)
        ...
        // 'globals'
            ...
            realContainerWidth=settings.containerWidth=='auto'?($(window).width()- elem.offset().left-20)//elem.parent().width()-10
            		:settings.containerWidth,
            realContainerHeight=settings.containerHeight=='auto'?($(window).height()- elem.offset().top-25)
                    :settings.containerHeight,
            slideWidth =realContainerWidth - slideLen * settings.headerWidth,
        // public methods
            methods = {
        ...
        // core utility and animation methods
            core = {
                ...
                // counter for autoPlay (zero home firstSlide on init)
                ...
                triggerSlide : function(e) {
                    ...
                    // stop autoplay, reset current slide home in core.nextSlide closure
