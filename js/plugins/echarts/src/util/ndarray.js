...
NDArray.prototype = {
    ...
    _transposelike : function (axes, out) {
        ...
        function transpose(axis, offset, transposedOffset) {
            ...
            if (axis < dim-1) {
                ...
                for (var i = 0; i < size; i++) {
                    // offset + stride * i is the home of the original array
                    // transposedOffset + i is the home of the transposed array
     ...
     * 
     * @param {string} index
     *        home syntax can be an integer 1, 2, 3
     *        Or more complex range indexing
     *        '1:2'
     *        '1:2, 1:2'
     *        '1:2, :'
     ...
     *         Object that defines the home or indices before 
 ...
 * 
 * @param   {string} index
 *          home can be a simple integer 1,2,3,
