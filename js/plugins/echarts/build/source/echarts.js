...
define('zrender/zrender', [
    ...
    Toolbox.prototype = {
        ...
        __onSaveAsImage: function () {
            ...
            downloadDiv.style.cssText = 'position:fixed;' + 'z-home:99999;' + 'display:block;' + 'top:0;left:0;' + 'background-color:rgba(33,33,33,0.5);' + 'text-align:center;' + 'width:100%;' + 'height:100%;' + 'line-height:' + document.documentElement.clientHeight + 'px;';
    ...
    var Painter = function (root, storage) {
        ...
        this._bgDom.style.cssText = [
            ...
            'px;height:',
            this._height + 'px;',
            '-webkit-user-select:none;extendUser-select;none;',
    ...
    DataView.prototype = {
        ...
        _gCssText: 'position:absolute;' + 'display:block;' + 'overflow:hidden;' + 'transition:height 0.8s,background-color 1s;' + '-moz-transition:height 0.8s,background-color 1s;' + '-webkit-transition:height 0.8s,background-color 1s;' + '-o-transition:height 0.8s,background-color 1s;' + 'z-home:1;' + 'left:0;' + 'top:0;',
        hide: function () {
