...
(function () {
    ...
    DayPilot.abs = function (element, $i) {
        ...
        if (element.getBoundingClientRect) {
            ...
            try {
                ...
                b = {top: element.offsetTop, $j: element.offsetLeft};
            }
            ;
            r.x = b.left;
            r.y = b.top;
    ...
    DayPilot.gs = function (el, $K) {
        var x = el;
        if (x.currentStyle)var y = x.currentStyle[$K]; else if (window.getComputedStyle)var y = document.defaultView.getComputedStyle(x, null).getPropertyValue($K);
    ...
    (function () {
        ...
        function createPlan($Z) {
            ...
            var $04 = {"fast": $03, "slow": $02, "jump": $00};
            if (!$04[$Z]) {
                $Z = "fast";
            }
            ;
    ...
    var $12 = function ($10, $11) {
        ...
        var $1q = [
            ...
            {"seq": "MMM", "expr": "[a-z]*", "str": function (d) {
                var r = $11.monthNamesShort[d.getMonth()];
                return r;
            }},
            ...
            {"seq": "ddd", "expr": "[a-z]*", "str": function (d) {
                var r = $11.dayNamesShort[d.getDayOfWeek()];
                return r;
            }},
            ...
            $1I.sendNavigate = function ($0D) {
                ...
                if ($1J) {
                    if ($1G.commandCallBack) {
                        $1G.commandCallBack("navigate", {"day": $0D});
                    }
                }
            };
            $1I.show = function () {
...
(function () {
    ...
    ;
    var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, $1R = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, $1S, $1T, $1U = {'\b': '\\b', '\t': '\\t', '\n': '\\n', '\f': '\\f', '\r': '\\r', '"': '\\"', '\\': '\\\\'}, $1V;
    ...
    function str($0o, $1W) {
        var i, k, v, length, $1X = $1S, $1Y, $1Z = $1W[$0o];
    ...
    DayPilot.Bubble = function ($e) {
        ...
        this.adjustPosition = function () {
            ...
            if ($p) {
                ...
                this.removeShadow();
                DayPilot.pop($n, {"finished": function () {
                    $n.firstChild.style.color = $I.color;
                    $n.style.overflow = $I.overflow;
                    $f.addShadow();
                }, "vertical": "bottom", "horizontal": "left", "animation": $f.animation});
            }
        };
...
(function () {
    ...
    DayPilot.Calendar = function (id) {
        ...
        this.$4e = function () {
            ...
            ;
            var $0L = this.columnsBottom;
            var $0M = (this.showHours ? this.hourWidth : 0);
            var $I = this.nav.main.rows[0].cells[0].clientWidth;
            var iw = 10;
            var $0N = 1;
            for (var i = 0; i < $0L.length; i++) {
                var $0O = this.nav.scrollUp[i];
                var $0P = this.nav.scrollDown[i];
                $0O.style.left = ($0M + i * $I + $I / 2 - (iw / 2) + $0N) + "px";
                $0P.style.left = ($0M + i * $I + $I / 2 - (iw / 2) + $0N) + "px";
            }
            ;
            var $0Q = this.$4V();
            for (var i = 0; i < this.nav.scrollUp.length; i++) {
                ...
                var $0S = this.scrollLabels[i].minEnd - $0Q;
                var $0T = this.scrollLabels[i].maxStart - $0Q;
                if (up && $0R) {
                    if ($0S <= $c.scrollPos) {
                    ...
                    ;
                    if ($0T >= $c.scrollPos + $c.scrollHeight) {
                        $0R.style.top = (this.$4o() + this.scrollHeight - 8) + "px";
                        $0R.style.display = '';
                    } else {
        ...
        this.$4W = function ($F) {
            var $0U = $F.parentNode;
            while ($0U && $0U.tagName !== "TD") {
                $0U = $0U.parentNode;
            }
            ;
            var $0V = document.createElement('textarea');
            $0V.style.position = 'absolute';
            $0V.style.width = ($F.parentNode.offsetWidth - 2) + 'px';
            $0V.style.height = ($F.offsetHeight - 2) + 'px';
            var $0W = DayPilot.gs($F, 'fontFamily');
            if (!$0W)$0W = DayPilot.gs($F, 'font-family');
            $0V.style.fontFamily = $0W;
            var $0X = DayPilot.gs($F, 'fontSize');
            if (!$0X)$0X = DayPilot.gs($F, 'font-size');
            $0V.style.fontSize = $0X;
            $0V.style.left = '0px';
            $0V.style.top = $F.offsetTop + 'px';
            $0V.style.border = '1px solid black';
            $0V.style.padding = '0px';
            $0V.style.marginTop = '0px';
            $0V.style.backgroundColor = 'white';
            $0V.value = DayPilot.tr($F.event.text());
            $0V.event = $F.event;
            $0U.firstChild.appendChild($0V);
            return $0V;
        };
        ...
        this.multiselect.$4O = function ($d, $0Z) {
            var m = $c.multiselect;
        ...
        this.multiselect.add = function (ev, $12) {
            var m = $c.multiselect;
            if (m.$55(ev) === -1) {
                m.$4X.push(ev);
            }
        ...
        this.multiselect.remove = function (ev, $12) {
            var m = $c.multiselect;
            var i = m.$55(ev);
            if (i !== -1) {
                m.$4X.splice(i, 1);
        ...
        this.multiselect.clear = function ($12) {
            var m = $c.multiselect;
            m.$4X = [];
            m.$51();
            if ($12) {
        ...
        this.multiselect.$57 = function ($d, $13) {
            var m = $c.multiselect;
            var cn = $c.cssOnly ? $c.$4i("_selected") : $c.$4i("selected");
            var c = m.$58($d);
        ...
        this.multiselect.$53 = function (e, $11) {
            if (!$11) {
                return false;
            }
            ;
        ...
        this.multiselect.$59 = function ($14) {
            var w = 5;
            if (!$14.top) {
                var top = document.createElement("div");
                top.setAttribute("unselectable", "on");
                top.style.position = 'absolute';
                top.style.left = $14.offsetLeft + 'px';
                top.style.width = $14.offsetWidth + 'px';
                top.style.top = ($14.offsetTop - w) + 'px';
                top.style.height = w + 'px';
                top.style.backgroundColor = $c.eventSelectColor;
                top.style.zIndex = 100;
                $14.parentNode.appendChild(top);
                $14.top = top;
            }
            ;
            if (!$14.bottom) {
                var $15 = document.createElement("div");
                $15.setAttribute("unselectable", "on");
                $15.style.position = 'absolute';
                $15.style.left = $14.offsetLeft + 'px';
                $15.style.width = $14.offsetWidth + 'px';
                $15.style.top = ($14.offsetTop + $14.offsetHeight) + 'px';
                $15.style.height = w + 'px';
                $15.style.backgroundColor = $c.eventSelectColor;
                $15.style.zIndex = 100;
                $14.parentNode.appendChild($15);
                $14.bottom = $15;
            }
        };
        this.multiselect.$5b = function ($14) {
            if ($14.top) {
                $14.parentNode.removeChild($14.top);
                $14.top = null;
            }
            ;
            if ($14.bottom) {
                $14.parentNode.removeChild($14.bottom);
                $14.bottom = null;
            }
        };
        this.$4t = function ($F) {
            ...
            $0V.onkeypress = function (e) {
                var $18 = (window.event) ? event.keyCode : e.keyCode;
                if ($18 === 13) {
                    this.onblur();
                    return false;
                } else if ($18 === 27) {
        ...
        this.$5g = function ($r) {
            ...
            $r.getChildren = function ($1b, $1c) {
                ...
                for (var i = 0; i < this.children.length; i++) {
                    var $1d = this.children[i];
                    var $1e = $1d.getChildren($1b - 1, $1c);
                    for (var j = 0; j < $1e.length; j++) {
                        $11.push($1e[j]);
                    }
                }
                ;
            ...
            $r.getChildrenCount = function ($1b) {
                var $10 = 0;
                if (!this.children || this.children.length <= 0 || $1b <= 1) {
                    return 1;
                }
                ;
                for (var i = 0; i < this.children.length; i++) {
                    $10 += this.children[i].getChildrenCount($1b - 1);
                }
                ;
                return $10;
            };
            $r.putIntoBlock = function (ep) {
                for (var i = 0; i < this.blocks.length; i++) {
                    var $1f = this.blocks[i];
                    if ($1f.overlapsWith(ep.part.top, ep.part.height)) {
                        $1f.events.push(ep);
                        $1f.min = Math.min($1f.min, ep.part.top);
                        $1f.max = Math.max($1f.max, ep.part.top + ep.part.height);
                        return i;
                    }
                }
                ;
                ...
                $1f.lines = [];
                $1f.events = [];
                $1f.overlapsWith = function ($08, $1g) {
                    var end = $08 + $1g - 1;
                ...
                $1f.putIntoLine = function (ep) {
                    var $1h = this;
                    for (var i = 0; i < this.lines.length; i++) {
                        var $1i = this.lines[i];
                        if ($1i.isFree(ep.part.top, ep.part.height)) {
                            $1i.push(ep);
                            return i;
                        }
                    }
                ...
                $1f.events.push(ep);
                $1f.min = ep.part.top;
                $1f.max = ep.part.top + ep.part.height;
                this.blocks.push($1f);
        ...
        this.$5e = function ($1b, $1c) {
            var $1j = this.columns || this.columnsBottom;
            var $11 = [];
            for (var i = 0; i < $1j.length; i++) {
                var $u = $1j[i].getChildren($1b, $1c);
        ...
        this.$4d = function () {
            ...
            ;
            var $1k = this.nav.header;
            if (!$1k) {
                return;
            }
            ;
            $1k.style.display = 'none';
            var $0L = this.columnsBottom.length;
            for (var j = 0; j < this.allDay.lines.length; j++) {
                var $1i = this.allDay.lines[j];
                for (var i = 0; i < $1i.length; i++) {
                    ...
                    $d.style.position = 'absolute';
                    if ($c.rtl) {
                        $d.style.right = (100.0 * $h.part.colStart / $0L) + "%";
                    } else {
                        $d.style.left = (100.0 * $h.part.colStart / $0L) + "%";
                    }
                    ;
                    $d.style.width = (100.0 * $h.part.colWidth / $0L) + "%";
                    ...
                    ;
                    var $1l = $h.start().getTime() === $h.part.start.getTime();
                    var $1m = $h.end().getTime() === $h.part.end.getTime();
                    ...
                    if (!this.cssOnly) {
                        ...
                        var $1q = this.showAllDayEventStartEnd;
                        var $1r = "Center";
                        var $1s = 0;
                        if ($1p) {
                            if ($1r === 'Left') {
                                $1n.push("<div unselectable='on' style='position:absolute;text-align:left;height:1px;font-size:1px;width:100%'><div unselectable='on' style='font-size:8pt;color:gray;text-align:right;");
                                $1n.push("width:");
                                $1n.push($1s - 4);
                                $1n.push("px;");
                                $1n.push("><span style='background-color:");
                            } else {
                                $1n.push("<div unselectable='on' style='position:absolute;text-align:left;height:1px;font-size:1px;width:100%'><div unselectable='on' style='font-size:8pt;color:gray'><span style='background-color:");
                            }
                            ;
                            $1n.push('transparent');
                            $1n.push("' unselectable='on'>");
                            if ($1l) {
                                if ($h.start().getDatePart().getTime() !== $h.start().getTime()) {
                                    $1n.push(DayPilot.Date.hours($h.start().d, this.$5h.timeFormat() === 'Clock12Hours'));
                                }
                            } else {
                                $1n.push("~");
                            }
                            ;
                            $1n.push("</span></div></div>");
                        }
                        ;
                        if ($1q) {
                            $1n.push("<div unselectable='on' style='position:absolute;text-align:right;height:1px;font-size:1px;width:100%'><div unselectable='on' style='margin-right:4px;font-size:8pt;color:gray'><span style='background-color:");
                            $1n.push('transparent');
                            $1n.push("' unselectable='on'>");
                            if ($1m) {
                                if ($h.end().getDatePart().getTime() !== $h.end().getTime()) {
                                    $1n.push(DayPilot.Date.hours($h.end().d, this.$5h.timeFormat() === 'Clock12Hours'));
                                }
                            } else {
                                $1n.push("~");
                            }
                        ...
                        if ($1r === 'Left') {
                            var $X = $1p ? $1s : 0;
                            $1n.push("<div style='margin-top:0px;height:");
                            $1n.push($0d.allDayEventHeight() - 2);
                            $1n.push("px;");
                            $1n.push(";overflow:hidden;text-align:left;padding-left:");
                            $1n.push($X);
                            $1n.push("px;font-size:");
                            $1n.push(this.allDayEventFontSize);
                            $1n.push(";color:");
                            $1n.push(this.allDayEventFontColor);
                            $1n.push(";font-family:");
                            $1n.push(this.eventFontFamily);
                            $1n.push("' unselectable='on'>");
                            if ($h.client.innerHTML()) {
                                $1n.push($h.client.innerHTML());
                            } else {
                                $1n.push($h.text());
                            }
                            ;
                            ...
                            if ($1o) {
                                $1n.push("<div style='position:absolute; text-align:center; width: 98%; height:1px;'>");
                                $1n.push("<span style='background-color:");
                                $1n.push('transparent');
                                $1n.push(";font-size:");
                                $1n.push(this.allDayEventFontSize);
                                ...
                                $1n.push(this.allDayEventFontColor);
                                $1n.push(";font-family:");
                                $1n.push(this.allDayEventFontFamily);
                                $1n.push("' unselectable='on'>");
                                if ($h.client.innerHTML()) {
                                    $1n.push($h.client.innerHTML());
                                } else {
                                ...
                                $1n.push($0d.allDayEventHeight() - 2);
                                $1n.push("px;");
                                $1n.push(";overflow:hidden;text-align:center;font-size:");
                                $1n.push(this.allDayEventFontSize);
                                $1n.push(";color:");
                                $1n.push(this.allDayEventFontColor);
                                $1n.push(";font-family:");
            ...
            if (this.elements.events) {
                for (var i = 0; i < this.elements.events.length; i++) {
                    ...
                    if ($d.firstChild && $d.firstChild.firstChild && $d.firstChild.firstChild.tagName && $d.firstChild.firstChild.tagName.toUpperCase() === 'IMG') {
                        var $1u = $d.firstChild.firstChild;
                        $1u.onmousedown = null;
                        $1u.onmousemove = null;
                        $1u.onclick = null;
                    }
        ...
        this.$5i = function ($h) {
            ...
            var $1v = this.roundedCorners;
            var $1w = this.roundedCorners && (this.$3C.ff || this.$3C.opera105 || this.$3C.webkit522 || !this.$3C.ielt9);
            var $1x = this.roundedCorners && !$1w;
            var $1y = $h.cache || $h.data;
            var $1z = $1y.borderColor || this.eventBorderColor;
            var $d = document.createElement("div");
            $d.setAttribute("unselectable", "on");
            ...
            if (!this.cssOnly) {
                ...
                $d.style.color = $1y.fontColor || this.eventFontColor;
                if (!$1v) {
                    $d.style.backgroundColor = $1z;
                }
                ;
                if (this.transparent) {
                    $d.style.opacity = 0.6;
            ...
            if (!this.cssOnly) {
                if (this.eventDeleteHandling !== 'Disabled' && $h.client.deleteEnabled()) {
                    $1n.push("<div unselectable='on' style='position:absolute; width:100%;text-align:right;'><div style='position:absolute; width:10px; height:10px; right:2px; top: 2px; cursor:pointer;");
                    if (this.deleteImageUrl) {
                        $1n.push("background-image:url(\"" + this.deleteImageUrl + "\");");
                    }
                    ;
                    $1n.push("' class='");
                    $1n.push(this.$4i("event_delete"));
                    $1n.push("' onmousemove=\"if(typeof(DayPilotBubble)!=='undefined'&&");
                    $1n.push(this.clientName);
                    $1n.push(".bubble && ");
                    $1n.push(this.clientName);
                    $1n.push(".bubble.hideAfter > 0");
                    $1n.push(") { DayPilotBubble.hideActive(); event.cancelBubble = true; };\" onmousedown=\"this.parentNode.parentNode.style.cursor='default';\" onclick='");
                    $1n.push(this.clientName);
                    $1n.push(".internal.eventDeleteDispatch(this); event.cancelBubble = true; if (event.stopPropagation) event.stopPropagation();' ></div></div>");
                }
                ;
                if ($1x) {
                    $1n.push("<div style='margin-right:2px;'>");
                    $1n.push("<div style='height:1px;line-height:1px;font-size:0px; margin-left:2px; background-color:");
                    $1n.push($1z);
                    $1n.push(";'>&nbsp;</div>");
                    $1n.push("</div>");
                    $1n.push("<div unselectable='on' style='position:absolute;width:100%;margin-top:-1px;'>");
                    $1n.push("<div style='height:1px;line-height:1px;font-size:0px;margin-left:1px;margin-top:1px; margin-right:1px;border-right:1px solid ");
                    $1n.push($1z);
                    $1n.push(";border-left:1px solid ");
                    $1n.push($1z);
                    $1n.push(";background-color:");
                    $1n.push($h.client.header() ? $1z : $h.BackgroundColor);
                    $1n.push("'>");
                    $1n.push("&nbsp;</div>");
                    $1n.push("</div>");
                } else if (!$1w) {
                    $1n.push("<div style='height:1px;line-height:1px;font-size:0px; width:1px;'>&nbsp;</div>");
                }
                ;
                $1n.push("<div");
                if (this.showToolTip && !this.bubble) {
                    $1n.push(" title='");
                    $1n.push($h.client.toolTip().replace(/'/g, "&apos;"));
                    $1n.push("'");
                }
                ;
                ...
                $1n.push(" c='1'");
                $1n.push(" class='");
                $1n.push($1y.cssClass || this.$4i('event'));
                $1n.push("'");
                if ($1x) {
                    $1n.push(" style='margin-top:1px;height:");
                    $1n.push($L - 2);
                } else {
                    $1n.push(" style='margin-top:0px;height:");
                    $1n.push($L);
                }
                ;
                $1n.push("px;background-color:");
                $1n.push($h.client.backColor());
                if ($1w) {
                    $1n.push(";border:1px solid ");
                    $1n.push($1z);
                    $1n.push(";-moz-border-radius:5px;");
                    $1n.push(";-webkit-border-radius:5px;");
                    $1n.push(";border-radius:5px;");
                } else {
                    $1n.push(";border-left:1px solid ");
                    $1n.push($1z);
                    $1n.push(";border-right:1px solid ");
                    $1n.push($1z);
                }
                ;
                $1n.push(";");
                if ($h.data.backgroundImage) {
                    $1n.push("background-image:url(");
                    $1n.push($h.data.backgroundImage);
                    $1n.push(");");
                    if ($h.data.backgroundRepeat) {
                        $1n.push("background-repeat:");
                        $1n.push($h.data.backgroundRepeat);
                        $1n.push(";");
                    }
                }
                ;
                if ($c.rtl) {
                    $1n.push("direction:rtl;");
                }
                ;
                $1n.push("' unselectable='on'>");
                if (this.durationBarVisible) {
                    var $1A = $h.client.barColor() || $c.durationBarColor;
                    $1n.push("<div style='position:absolute;left:1px;top:1px;width:");
                    $1n.push($c.durationBarWidth - 1);
                    $1n.push("px;height:");
                    $1n.push($h.part.barTop);
                    $1n.push("px;background-color:white;font-size:1px' unselectable='on'></div>");
                    $1n.push("<div style='position:absolute;left:1px;top:");
                    $1n.push($h.part.barTop + $h.part.barHeight);
                    $1n.push("px;width:");
                    $1n.push($c.durationBarWidth - 1);
                    $1n.push("px;height:");
                    $1n.push($L - ($h.part.barTop + $h.part.barHeight));
                    $1n.push("px;background-color:white;font-size:1px' unselectable='on'></div>");
                    $1n.push("<div style='position:absolute;left:1px;width:");
                    $1n.push($c.durationBarWidth);
                    $1n.push("px;height:");
                    $1n.push($h.part.barHeight);
                    $1n.push("px;");
                    if ($h.data.durationBarImageUrl) {
                        $1n.push("background-image:url(");
                        $1n.push($h.data.durationBarImageUrl);
                        $1n.push(");");
                    } else if ($c.durationBarImageUrl) {
                        $1n.push("background-image:url(");
                        $1n.push($c.durationBarImageUrl);
                        $1n.push(");");
                    }
                    ;
                    $1n.push("top:");
                    $1n.push($h.part.barTop + 1);
                    $1n.push("px;background-color:");
                    $1n.push($1A);
                    $1n.push(";font-size:1px' unselectable='on'></div><div style='position:absolute;left:");
                    $1n.push($c.durationBarWidth);
                    $1n.push("px;top:1px;width:1px;background-color:");
                    $1n.push($1z);
                    $1n.push(";height:100%' unselectable='on'></div>");
                }
                ;
                var $1B = $h.client.header() ? this.eventHeaderHeight : 0;
                if ($h.client.header()) {
                    $1n.push("<div unselectable='on' style='overflow:hidden;height:");
                    $1n.push(this.eventHeaderHeight);
                    $1n.push("px; background-color:");
                    $1n.push($1z);
                    $1n.push(";font-size:");
                    $1n.push(this.eventHeaderFontSize);
                    $1n.push(";color:");
                    $1n.push(this.eventHeaderFontColor);
                    $1n.push("'>");
                    $1n.push($h.client.header());
                    $1n.push("</div>");
                }
                ;
                if (this.durationBarVisible) {
                    $1n.push("<div unselectable='on' style='padding-left:");
                    $1n.push($c.durationBarWidth + 3);
                    $1n.push("px;");
                } else {
                    $1n.push("<div unselectable='on' style='overflow:hidden;padding-left:2px;height:");
                    $1n.push($L - $1B - 1);
                    $1n.push("px;");
                }
                ;
                ...
                $1n.push("</div></div>");
                if ($1x) {
                    $1n.push("<div unselectable='on' style='margin-right:2px;'>");
                    $1n.push("<div unselectable='on' style='height:1px;line-height:1px;font-size:0px;margin-left:2px;margin-top:1px;background-color:");
                    $1n.push($1z);
                    $1n.push(";'><!-- --></div>");
                    $1n.push("</div>");
                    $1n.push("<div unselectable='on' style='margin-right:0px;margin-top:-3px;position:relative;'>");
                    $1n.push("<div unselectable='on' style='margin-right:0px;position:relative;'>");
                    $1n.push("<div unselectable='on' style='height:1px;line-height:1px;font-size:0px;margin-top:1px;margin-left:1px;margin-right:1px;border-right:1px solid ");
                    $1n.push($1z);
                    $1n.push(";border-left:1px solid ");
                    $1n.push($1z);
                    $1n.push(";background-color:");
                ...
                if ($1y.cssClass) {
                    DayPilot.Util.addClass($d, $1y.cssClass);
                }
                ;
                var $N = document.createElement("div");
                $N.setAttribute("unselectable", "on");
                ...
                $N.innerHTML = $h.client.innerHTML();
                if ($1y.backColor) {
                    $N.style.background = $1y.backColor;
                }
                ;
                if ($1y.borderColor) {
                    $N.style.borderColor = $1y.borderColor;
                }
                ;
                if ($1y.backgroundImage) {
                    $N.style.backgroundImage = "url(" + $1y.backgroundImage + ")";
                    if ($1y.backgroundRepeat) {
                        $N.style.backgroundRepeat = $1y.backgroundRepeat;
                    }
                }
                ;
                $d.appendChild($N);
                if ($h.client.barVisible()) {
                    ...
                    var $1C = 100 * $h.part.barTop / $L;
                    var $1D = Math.ceil(100 * $h.part.barHeight / $L);
                    ...
                    $1G.className = this.$4i("_event_bar");
                    $1G.style.position = "absolute";
                    var $1H = document.createElement("div");
                    $1H.setAttribute("unselectable", "on");
                    $1H.className = this.$4i("_event_bar_inner");
                    $1H.style.top = $1C + "%";
                    if (0 < $1D && $1D <= 1) {
                        $1H.style.height = "1px";
                    } else {
            ...
            ;
            if ($1y.areas) {
                for (var i = 0; i < $1y.areas.length; i++) {
                    var $1I = $1y.areas[i];
                    if ($1I.v !== 'Visible') {
                        continue;
                    }
                    ;
                    var a = DayPilot.Areas.createArea($d, $h, $1I);
                    $d.appendChild(a);
                }
            }
            ;
            if ($H.rows[0].cells[$h.part.dayIndex]) {
                var $1J = $H.rows[0].cells[$h.part.dayIndex].firstChild;
                $1J.appendChild($d);
                $c.$5n($d);
                $d.event = $h;
        ...
        this.$4c = function () {
            ...
            for (var i = 0; i < this.columnsBottom.length; i++) {
                var $1K = this.columnsBottom[i];
                for (var m = 0; m < $1K.blocks.length; m++) {
                    var $1f = $1K.blocks[m];
                    for (var j = 0; j < $1f.lines.length; j++) {
                        var $1i = $1f.lines[j];
                        for (var k = 0; k < $1i.length; k++) {
                            var e = $1i[k];
                            e.part.width = 100 / $1f.lines.length;
                            e.part.left = e.part.width * j;
                            if (this.eventArrangement === 'Cascade') {
                                var $1L = (j === $1f.lines.length - 1);
                                if (!$1L) {
            ...
            var end = new Date();
            var $1M = end.getTime() - $08.getTime();
        };
        this.$5o = function () {
            this.multiselect.$4X = [];
            for (var i = 0; i < this.columnsBottom.length; i++) {
                var $1K = this.columnsBottom[i];
                for (var j = 0; j < $1K.lines.length; j++) {
                    var $1i = $1K.lines[j];
                    for (var k = 0; k < $1i.length; k++) {
                        var e = $1i[k];
                        e.part.width = 100 / $1K.lines.length;
        ...
        this.$5r = function () {
            ...
            ;
            var $0K = this.columnWidthSpec === 'Fixed';
            if (!$0K) {
        ...
        this.$5z = function ($1W, i) {
            ...
            if (this.cssOnly) {
                $1f.className = this.$4i("_rowheader_inner");
            }
            ;
            $1f.setAttribute("unselectable", "on");
            if (!this.cssOnly) {
                $1f.style.borderBottom = "1px solid " + this.hourNameBorderColor;
                $1f.style.textAlign = "right";
                $1f.style.height = ($L - 1) + "px";
            }
            ;
            var $S = null;
            var $h = null;
        ...
        this.$5s = function () {
            ...
            if (!this.cssOnly) {
                $1k.style.borderLeft = "1px solid " + this.borderColor;
                $1k.style.borderRight = "1px solid " + this.borderColor;
            }
            ;
            var $0K = this.columnWidthSpec === 'Fixed';
            if (!$0K) {
                $1k.style.overflow = "auto";
            }
            ;
        ...
        this.$5H = function () {
            ...
            $1n.setAttribute("unselectable", "on");
            if (this.cssOnly) {
                $1n.className = this.$4i('_cornerright');
            }
            ;
            $1n.style.overflow = "hidden";
            $1n.style.position = "relative";
            $1n.style.width = "16px";
            $1n.style.height = this.$4o() + "px";
            var $N = document.createElement("div");
            if (this.cssOnly) {
...
//            $1P.appendChild($2b);
        ...
        this.$47 = function () {
            ...
            var $2c = this.$4q();
            var $0L = $c.columnsBottom;
            var $1Y = !this.tableCreated || $1W.rows.length === 0 || $0L.length !== $1W.rows[0].cells.length || $2c !== $1W.rows.length;
            if ($1W) {
                this.$3N();
                if ($c.$3C.ielt9 && $1Y) {
            ...
            if (this.scrollLabelsVisible) {
                var $0L = this.columnsBottom;
                var $0M = (this.showHours ? this.hourWidth : 0);
                var $I = (this.nav.scroll.clientWidth - $0M) / $0L.length;
                for (var i = 0; i < $0L.length; i++) {
                    var $0O = document.createElement("div");
                    $0O.style.position = 'absolute';
                    $0O.style.top = '0px';
                    $0O.style.left = ($0M + 2 + i * $I + $I / 2) + "px";
                    $0O.style.display = 'none';
                    var $1u = document.createElement("div");
                    $1u.style.height = '10px';
                    $1u.style.width = '10px';
                    if (this.cssOnly) {
                        $1u.className = this.$4i("_scroll_up");
                    } else {
                        $1u.style.backgroundRepeat = "no-repeat";
                        if (this.scrollUpUrl) {
                            $1u.style.backgroundImage = "url('" + this.scrollUpUrl + "')";
                        }
                        ;
                        $1u.className = this.$4i("scroll_up");
                    }
                    ;
                    $0O.appendChild($1u);
                    this.nav.scrollLayer.appendChild($0O);
                    this.nav.scrollUp.push($0O);
                    var $0P = document.createElement("div");
                    $0P.style.position = 'absolute';
                    $0P.style.top = '0px';
                    $0P.style.left = ($0M + 2 + i * $I + $I / 2) + "px";
                    $0P.style.display = 'none';
                    var $1u = document.createElement("div");
                    $1u.style.height = '10px';
                    $1u.style.width = '10px';
                    if (this.cssOnly) {
                        $1u.className = this.$4i("_scroll_down");
                    } else {
                        $1u.style.backgroundRepeat = "no-repeat";
                        if (this.scrollDownUrl) {
                            $1u.style.backgroundImage = "url('" + this.scrollDownUrl + "')";
                        }
                        ;
                        $1u.className = this.$4i("scroll_down");
                    }
                    ;
                    $0P.appendChild($1u);
                    this.nav.scrollLayer.appendChild($0P);
                    this.nav.scrollDown.push($0P);
                }
            }
            ;
            var cl = $0L.length;
            if (this.cssOnly || this.separateEventsTable) {
                var $0Y = this.nav.events;
                while ($0Y && $0Y.rows && $0Y.rows.length > 0 && $1Y) {
                    if (!this.fasterDispose)DayPilot.pu($0Y.rows[0]);
                    $0Y.deleteRow(0);
                }
                ;
                var r = ($1Y) ? $0Y.insertRow(-1) : $0Y.rows[0];
                for (var j = 0; j < cl; j++) {
                    var c = ($1Y) ? r.insertCell(-1) : r.cells[j];
                    if ($1Y) {
                        c.style.padding = '0px';
            ...
            for (var i = 0; i < $2c; i++) {
                ...
                ;
                for (var j = 0; j < cl; j++) {
                    var $1K = this.columnsBottom[j];
                    var c = ($1Y) ? r.insertCell(-1) : r.cells[j];
                    c.start = $1K.start.addTime(i * $0j).addHours(this.$4n());
                    ...
                    ;
                    var $S = this.cssOnly ? $2f.firstChild : $2f;
                    if ($S) {
                        $S.innerHTML = '';
                    }
                    ;
                    $2f.style.backgroundImage = "";
                    $2f.style.backgroundRepeat = "";
                    if ($2e) {
                        if ($2e.html) {
                            $S.innerHTML = $2e.html;
                        }
        ...
        this.$5w = function (ev) {
            ...
            if (DayPilot.Global.resizing) {
                ...
                var $2k = $c.cellHeight;
                var $J = 0;
                var $0N = DayPilotCalendar.moveOffsetY;
                if (!$0N) {
                    $0N = $2k / 2;
                }
                ;
                ...
                ;
                var $2n = Math.floor((($c.coords.y - $0N - $J) + $2k / 2) / $2k) * $2k + $J;
                if ($2n < $J) {
                    $2n = $J;
                }
                ;
                ...
                ;
                var $0Y = $c.nav.events;
                if ($r < $0Y.rows[0].cells.length && $r >= 0 && DayPilotCalendar.movingShadow.column !== $r) {
                    DayPilotCalendar.movingShadow.column = $r;
                    DayPilotCalendar.moveShadow($0Y.rows[0].cells[$r]);
                }
            }
            ;
            if (DayPilotCalendar.drag) {
                ...
                if (!DayPilotCalendar.movingShadow && $c.coords) {
                    ...
                    if ($M) {
                        ...
                        var ev = {'value': DayPilotCalendar.drag.id, 'start': $0E, 'end': $0E.addSeconds(DayPilotCalendar.drag.duration), 'text': DayPilotCalendar.drag.text};
        ...
        this.$5P = function ($1b, $1Y) {
            var r = ($1Y) ? this.nav.header.insertRow(-1) : this.nav.header.rows[$1b - 1];
            var $0L = this.$5e($1b);
            var $2A = $0L.length;
            var $2B = ($1b === $c.headerLevels);
            for (var i = 0; i < $2A; i++) {
                var $h = $0L[i];
                if ($c.$4g()) {
                ...
                if ($2B) {
                    ...
                    var $2D = 1;
                    if ($2C) {
                        $2D = $h.getChildrenCount($c.headerLevels - $1b + 1);
                    }
                    ;
                    $f.colSpan = $2D;
                }
        ...
        this.$5Q = function ($d, $h) {
            ...
            if ($h.areas) {
                ...
                for (var j = 0; j < $2F.length; j++) {
                    ...
                    var a = DayPilot.Areas.createArea($d, o, $1I);
                    $d.appendChild(a);
                }
            }
        };
        this.$43 = function () {
            ...
            var $1k = this.nav.header;
            var $1Y = true;
            var $0L = this.$5e($c.headerLevels, true);
            var $2A = $0L.length;
            if (this.headerCreated && $1k && $1k.rows && $1k.rows.length > 0) {
                $1Y = $1k.rows[$1k.rows.length - 1].cells.length !== $2A;
            }
            ;
            ...
            while (this.headerCreated && $1k && $1k.rows && $1k.rows.length > 0 && $1Y) {
                if (!this.fasterDispose)DayPilot.pu($1k.rows[0]);
                $1k.deleteRow(0);
            }
            ;
        ...
        this.$5R = function () {
            var $0K = this.columnWidthSpec === 'Fixed';
            var $2G = $0K ? this.nav.bottomRight : this.nav.scroll;
        ...
        this.$5l = function (ev) {
            ...
            if ((this.style.cursor === 'n-resize' || this.style.cursor === 's-resize') && $0B === 1) {
                ...
                DayPilotCalendar.originalMouse = DayPilot.mc(ev);
                DayPilotCalendar.originalTop = this.offsetTop;
                var $0N = DayPilot.mo3(this, ev);
                if ($0N) {
                    DayPilotCalendar.moveOffsetY = $0N.y;
                } else {
        ...
        this.$5m.getCellCoords = function (x, y) {
            ...
            var $2O = {x: x - $2N.x, y: y - $2N.y};
            var w = ($c.nav.main.clientWidth / $c.columnsBottom.length);
            var $2p = {x: Math.floor($2O.x / w), y: Math.floor($2O.y / $c.cellHeight), toString: function () {
        ...
        this.$5m.updateMoving = function ($2p) {
            ...
            ;
            var $2n = Math.floor((($2p.y - $0N - $J) + $2k / 2) / $2k) * $2k + $J;
            if ($2n < $J) {
                $2n = $J;
            }
            ;
        ...
        this.$5m.onEventTouchStart = function (ev) {
            ...
            var x = ev.touches[0].pageX;
            var y = ev.touches[0].pageY;
            var $2p = {x: x, y: y, $d: this};
            var $2N = DayPilot.abs($c.nav.scrollable);
            $c.coords = {x: x - $2N.x, y: y - $2N.y};
            var $2P = 500;
            $2M.timeout = window.setTimeout(function () {
                $2M.active = true;
                $2M.startMoving($d, $2p);
        ...
        this.$5j = function (ev) {
            ...
            ;
            if (!$1k && $0N.x <= $2S && this.event.client.moveEnabled()) {
                if ($2T) {
                    this.style.cursor = 'move';
                } else {
                    this.style.cursor = 'not-allowed';
                }
            } else if (!$1k && $0N.y <= $2R && this.event.client.resizeEnabled()) {
                if ($2T) {
            ...
            } else if ($1k && $0N.y <= $2S && this.event.client.moveEnabled()) {
                this.style.cursor = "move";
            } else if (this.offsetHeight - $0N.y <= $2R && this.event.client.resizeEnabled()) {
                if ($2U) {
            ...
            if (typeof(DayPilotBubble) !== 'undefined' && $c.bubble && $c.eventHoverHandling !== 'Disabled') {
                if (this.style.cursor === 'default' || this.style.cursor === 'pointer') {
                    var $2V = this.$5V && $0N.x === this.$5V.x && $0N.y === this.$5V.y;
                    if (!$2V) {
                        this.$5V = $0N;
                        $c.bubble.showEvent(this.event);
                    }
        ...
        this.$41 = function ($0Y) {
            ...
            for (var i = 0; i < this.columnsBottom.length; i++) {
                ...
                $1K.lines = [];
                $1K.blocks = [];
                var $30 = new DayPilot.Date($1K.start).addHours(this.$4n(true));
                var $31 = $30.getTime();
                var $32 = $30.addTime($K);
                var $33 = $32.getTime();
                if ($2X) {
                ...
                for (var j = 0; j < length; j++) {
                    ...
                    var $36 = false;
                    if ($2X) {
                        $36 = ($1K.id === e.resource) && !($35 <= $31 || $34 >= $33);
                    } else {
                    ...
                    if ($36) {
                        ...
                        var $37 = this.$5W(ep.part.start, $1K.start);
                        var $38 = this.$5W(ep.part.end, $1K.start);
                        var top = $37.top;
                        var $15 = $38.top;
                        if (top === $15 && ($37.cut || $38.cut)) {
                            continue;
                        }
                        ;
                        ...
                        if (ep.part.box) {
                            ...
                            ep.part.barHeight = Math.max($15 - top - 2, 1);
                        } else {
                            ep.part.top = top + $J;
                            ep.part.height = Math.max($15 - top, 0);
                            ep.part.barTop = 0;
                            ep.part.barHeight = Math.max($15 - top - 2, 1);
                        }
                        ;
            ...
            for (var i = 0; i < this.columnsBottom.length; i++) {
                var $1K = this.columnsBottom[i];
                $1K.events.sort(this.$5X);
                for (var j = 0; j < $1K.events.length; j++) {
                    var e = $1K.events[j];
                    $1K.putIntoBlock(e);
                }
                ;
                for (var j = 0; j < $1K.blocks.length; j++) {
                    var $1f = $1K.blocks[j];
                    $1f.events.sort(this.$5Y);
                    for (var k = 0; k < $1f.events.length; k++) {
                        var e = $1f.events[k];
                        $1f.putIntoLine(e);
                    }
                }
            ...
            this.allDay.putIntoLine = function (ep) {
                ...
                for (var i = 0; i < this.lines.length; i++) {
                    var $1i = this.lines[i];
                    if ($1i.isFree(ep.part.colStart, ep.part.colWidth)) {
                        $1i.push(ep);
                        return i;
                    }
                }
        ...
        this.$42 = function () {
            ...
            var $3r = this.$5p();
            if (this.nav.corner) {
                this.nav.corner.style.height = $1k + "px";
            }
            ;
            if (this.nav.cornerRight) {
                this.nav.cornerRight.style.height = $1k + "px";
            }
            ;
            if (this.nav.mid) {
                this.nav.mid.style.height = $1k + "px";
            }
            ;
            ...
            if (this.nav.upperRight) {
                this.nav.upperRight.style.height = $1k + "px";
            }
            ;
            this.nav.scroll.style.top = $1k + "px";
        ...
        this.setHeight = function ($1x) {
            if (this.heightSpec !== "Parent100Pct") {
                this.heightSpec = "Fixed";
            }
            ;
            if (this.cssOnly) {
                this.height = $1x - (this.$4o());
            } else {
                this.height = $1x - (this.$4o() + 3);
            }
            ;
            this.$49();
        };
...
(function () {
    ...
    DayPilot.Month = function ($c) {
        ...
        $T.relativeCoords = function (ev) {
            ...
            var $07 = {x: x - $0e.x, y: y - $0e.y, toString: function () {
                return "x: " + this.x + ", y:" + this.y;
            }};
            return $07;
        };
...
//            $u.innerHTML = "\u0044\u0045\u004D\u004F";
        ...
        this.events.find = function (id) {
            if (!$d.events.list || typeof $d.events.list.length === 'undefined') {
                return null;
            }
            ;
...
(function () {
    ...
    (function () {
        ...
        $d.add(".scheduler_default_event_move_left", 'box-sizing: border-box; padding:2px;border:1px solid #ccc;background:#fff;background: -webkit-gradient(linear, left top, left bottom, from(#ffffff), to(#eeeeee));background: -webkit-linear-gradient(top, #ffffff 0%, #eeeeee);background: -moz-linear-gradient(top, #ffffff 0%, #eeeeee);background: -ms-linear-gradient(top, #ffffff 0%, #eeeeee);background: -o-linear-gradient(top, #ffffff 0%, #eeeeee);background: linear-gradient(top, #ffffff 0%, #eeeeee);filter: progid:DXImageTransform.Microsoft.Gradient(startColorStr="#ffffff", endColorStr="#eeeeee");');
        $d.add(".scheduler_default_event_move_right", 'box-sizing: border-box; padding:2px;border:1px solid #ccc;background:#fff;background: -webkit-gradient(linear, left top, left bottom, from(#ffffff), to(#eeeeee));background: -webkit-linear-gradient(top, #ffffff 0%, #eeeeee);background: -moz-linear-gradient(top, #ffffff 0%, #eeeeee);background: -ms-linear-gradient(top, #ffffff 0%, #eeeeee);background: -o-linear-gradient(top, #ffffff 0%, #eeeeee);background: linear-gradient(top, #ffffff 0%, #eeeeee);filter: progid:DXImageTransform.Microsoft.Gradient(startColorStr="#ffffff", endColorStr="#eeeeee");');
        $d.commit();
    ...
    DayPilot.Scheduler = function (id) {
        ...
        this.$59 = {};
        this.$59.cells = [];
        this.$59.linesVertical = [];
        this.$59.linesHorizontal = [];
        this.$59.timeHeaderGroups = [];
        this.$59.pixels = [];
        this.$59.breaks = [];
        this.$59.events = [];
        this.clientState = {};
        this.nav = {};
        this.$5a = function ($f, $g) {
            var $f = eval("(" + $f + ")");
            if ($f.BubbleGuid) {
                var $h = $f.BubbleGuid;
        ...
        this.$5E = function () {
            ...
            for (var y = 0; y < this.timeHeader.length; y++) {
                for (var x = 0; x < this.timeHeader[y].length; x++) {
                    ...
                    if ($x < $v && $v < $y) {
                        ...
                        $z.marginLeft = $v - $x;
                        $z.marginRight = 0;
                        $z.div = this.$59.timeHeader[x + "_" + y];
                        $w.push($z);
                    }
                    ;
                    if ($x < end && end < $y) {
            ...
            for (var i = 0; i < $w.length; i++) {
                var $z = $w[i];
                this.$5H($z.div, $z.marginLeft, $z.marginRight);
            }
        };
        this.$5y = function () {
            this.$5E();
        ...
        this.$5H = function ($B, $A, $C) {
            var $D = document.createElement("div");
            $D.setAttribute("unselectable", "on");
            $D.className = this.$5L("_timeheader_float");
            $D.style.position = "absolute";
            $D.style.left = $A + "px";
            $D.style.right = $C + "px";
            $D.style.top = "0px";
            ...
            $D.style.overflow = "hidden";
            var $E = document.createElement("div");
            $E.className = this.$5L("_timeheader_float_inner");
            $E.setAttribute("unselectable", "on");
        ...
        this.$5K = function ($B, $A, $C) {
            var $D = document.createElement("div");
            $D.setAttribute("unselectable", "on");
            $D.className = this.$5L("_event_float");
            $D.style.position = "absolute";
            $D.style.left = $A + "px";
            $D.style.right = $C + "px";
            $D.style.top = "0px";
            ...
            $D.style.overflow = "hidden";
            var $E = document.createElement("div");
            $E.className = this.$5L("_event_float_inner");
            $E.setAttribute("unselectable", "on");
        ...
        this.message = function ($H, $I, $J, $K) {
            ...
            if (!this.nav.message) {
                ...
                $B.onmouseout = function () {
                    if ($e.nav.message.style.display !== 'none') {
                        $e.messageTimeout = setTimeout($e.$5P, 500);
                    }
                };
                var $E = document.createElement("div");
                $E.onclick = function () {
                ...
                if (!this.cssOnly) {
                    ...
                    close.className = this.$5L("_message_close");
                }
                ;
                close.onclick = function () {
                    $e.nav.message.style.display = 'none';
            ...
            var $N = function () {
                ...
                ;
                var end = function () {
                    $e.messageTimeout = setTimeout($e.$5P, $I);
                };
        ...
        this.$5o = function () {
            if (this.nav.scroll) {
                if (this.heightSpec === 'Parent100Pct') {
                    this.height = parseInt(this.nav.top.clientHeight, 10) - (this.$5N() + 2);
                }
                ;
                var $P = this.$5Q();
                var $Q = 1;
            ...
            if (this.$5T()) {
                if (this.timeline) {
                    ...
                    for (var i = 0; i < this.timeline.length; i++) {
                        var $X = this.timeline[i];
                        var $z = {};
                        $z.start = new DayPilot.Date($X.start);
                        $z.end = $X.end ? new DayPilot.Date($X.end) : $z.start.addMinutes(this.cellDuration);
                        if (!$X.width) {
                            var $y = Math.floor($x + this.cellWidth);
                            var $V = $y - Math.floor($x);
                            $z.left = Math.floor($x);
                            $z.width = $V;
                            $x += this.cellWidth;
                        } else {
                            $z.left = $X.left || $x;
                            $z.width = $X.width || this.cellWidth;
                            $x += $z.width;
                        }
                        ;
                        $z.breakBefore = $W && $W.ticks !== $z.start.ticks;
                        $W = $z.end;
                        this.itline.push($z);
                    }
                }
        ...
        this.getDate = function ($x, $0g, $0h) {
            ...
            if (!$0g) {
                ...
                return $v.addTime(this.$62($O.cell, $O.offset));
            }
        };
        this.$61 = function ($s, $0h) {
            var $0j = 0;
            var $09 = 0;
            for (var i = 0; i < this.itline.length; i++) {
                var $z = this.itline[i];
                var $V = $z.width || this.cellWidth;
                $0j += $V;
                if (($s < $0j) || ($0h && $s === $0j)) {
                    var $f = {};
                    $f.x = i;
        ...
        this.$60 = function ($z, $07) {
            var $V = $z.width || this.cellWidth;
            var $0l = $z.end.ticks - $z.start.ticks;
            return Math.floor(($V * $07) / ($0l));
        };
        this.$62 = function ($z, $s) {
            var $0l = $z.end.ticks - $z.start.ticks;
            var $V = $z.width || this.cellWidth;
            return Math.floor($s / $V * $0l);
        };
        this.$64 = function (ev) {
            if ($0m.start) {
                return;
        ...
        this.eventClickPostBack = function (e, $m) {
            this.$66('EventClick', e, $m);
        };
        this.eventClickCallBack = function (e, $m) {
            this.$67('EventClick', e, $m);
        };
        this.$65 = function ($B, ev) {
            var e = $B.event;
            var ev = ev || window.event;
            if (typeof(DayPilotBubble) !== 'undefined') {
                DayPilotBubble.hideActive();
        ...
        this.eventSelectPostBack = function (e, $0r, $m) {
            ...
            $0s.e = e;
            $0s.change = $0r;
            this.$66('EventSelect', $0s, $m);
        };
        this.eventSelectCallBack = function (e, $0r, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.change = $0r;
            this.$67('EventSelect', $0s, $m);
        };
        this.$6b = function ($B, e, $0p) {
            if ($e.$5C()) {
                var m = $e.multiselect;
                m.previous = m.events();
                var $q = {};
        ...
        this.eventRightClickPostBack = function (e, $m) {
            this.$66('EventRightClick', e, $m);
        };
        this.eventRightClickCallBack = function (e, $m) {
            this.$67('EventRightClick', e, $m);
        };
        this.$6d = function (ev) {
            var e = this.event;
            ev = ev || window.event;
        ...
        this.eventDoubleClickPostBack = function (e, $m) {
            this.$66('EventDoubleClick', e, $m);
        };
        this.eventDoubleClickCallBack = function (e, $m) {
            this.$67('EventDoubleClick', e, $m);
        };
        this.$6e = function (ev) {
            if (typeof(DayPilotBubble) !== 'undefined') {
                DayPilotBubble.hideActive();
        ...
        this.eventResizePostBack = function (e, $0u, $0v, $m) {
            this.$6f("PostBack", e, $0u, $0v, $m);
        };
        this.eventResizeCallBack = function (e, $0u, $0v, $m) {
            this.$6f("CallBack", e, $0u, $0v, $m);
        };
        this.$6f = function ($0w, e, $0u, $0v, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.newStart = $0u;
            $0s.newEnd = $0v;
            this.$6g($0w, "EventResize", $0s, $m);
        };
        this.$6h = function (e, $0u, $0v) {
            if (this.eventResizeHandling === 'Disabled') {
                return;
            }
            ;
        ...
        this.eventMovePostBack = function (e, $0u, $0v, $0x, $m, $03) {
            this.$6i("PostBack", e, $0u, $0v, $0x, $m, $03);
        };
        this.eventMoveCallBack = function (e, $0u, $0v, $0x, $m, $03) {
            this.$6i("CallBack", e, $0u, $0v, $0x, $m, $03);
        };
        this.$6i = function ($0w, e, $0u, $0v, $0x, $m, $03) {
            var $0s = {};
            $0s.e = e;
            $0s.newStart = $0u;
            $0s.newEnd = $0v;
            $0s.newResource = $0x;
            $0s.position = $03;
            this.$6g($0w, "EventMove", $0s, $m);
        };
        this.$6g = function ($0w, $0y, $0s, $m) {
            if ($0w === 'PostBack') {
                $e.$66($0y, $0s, $m);
            } else if ($0w === 'CallBack') {
                $e.$67($0y, $0s, $m, "CallBack");
        ...
        this.eventMoveNotify = function (e, $0u, $0v, $0x, $m, $03) {
            ...
            var $0A = $e.events.$6j(e.data);
            e.start($0u);
            e.end($0v);
            e.resource($0x);
            e.commit();
            $0A = $0A.concat($e.events.$6k(e.data));
            $e.$6l($0A);
            $e.$6m();
            $e.$6n($0A);
            this.$6i("Notify", $0z, $0u, $0v, $0x, $m, $03);
        };
        ...
        this.multiselect.$6c = function ($B, $0C) {
            var m = $e.multiselect;
        ...
        this.multiselect.$6r = function (ev) {
            var m = $e.multiselect;
            return m.$6s(ev, m.initList);
        };
        this.multiselect.$6t = function () {
            var m = $e.multiselect;
            var $0D = [];
            for (var i = 0; i < m.list.length; i++) {
                var event = m.list[i];
        ...
        this.multiselect.$6w = function (ev) {
            var m = $e.multiselect;
            var $B = null;
            for (var i = 0; i < $e.elements.events.length; i++) {
        ...
        this.multiselect.$6q = function ($B) {
            if (!$B) {
                return;
            }
            ;
        ...
        this.multiselect.$6u = function ($B) {
            var m = $e.multiselect;
            var cn = $e.cssOnly ? $e.$5L("_selected") : $e.$5L("selected");
            var $B = m.$6x($B);
            DayPilot.Util.addClass($B, cn);
            m.divs.push($B);
        };
        this.multiselect.$6x = function ($B) {
            return $B;
        };
        this.multiselect.$6y = function () {
            var m = $e.multiselect;
            for (var i = 0; i < m.divs.length; i++) {
                var $B = m.divs[i];
                m.$6v($B, true);
        ...
        this.multiselect.$6v = function ($B, $0F) {
            var m = $e.multiselect;
            var cn = $e.cssOnly ? $e.$5L("_selected") : $e.$5L("selected");
        ...
        this.multiselect.isSelected = function (ev) {
            return $e.multiselect.$6s(ev, $e.multiselect.list);
        };
        this.multiselect.indexOf = function (ev) {
            return DayPilot.indexOf($e.multiselect.list, ev);
        };
        this.multiselect.$6s = function (e, $0D) {
            if (!$0D) {
                return false;
            }
            ;
        ...
        this.$6D = function (e, $0u, $0v, $0x, external, ev, $03) {
        ...
        this.eventMenuClickPostBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.command = $0L;
            this.$66('EventMenuClick', $0s, $m);
        };
        this.eventMenuClickCallBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.command = $0L;
            this.$67('EventMenuClick', $0s, $m);
        };
        this.$6G = function ($0L, e, $0M) {
            switch ($0M) {
                case 'PostBack':
                    $e.eventMenuClickPostBack(e, $0L);
                    break;
                case 'CallBack':
                    $e.eventMenuClickCallBack(e, $0L);
                    break;
            }
        };
        this.timeRangeSelectedPostBack = function ($v, end, $0N, $m) {
            var $0O = {};
            $0O.start = $v;
            $0O.end = end;
            $0O.resource = $0N;
            this.$66('TimeRangeSelected', $0O, $m);
        };
        this.timeRangeSelectedCallBack = function ($v, end, $0N, $m) {
            var $0O = {};
            $0O.start = $v;
            $0O.end = end;
            $0O.resource = $0N;
            this.$67('TimeRangeSelected', $0O, $m);
        };
        this.$6H = function ($v, end, $0N) {
            ...
            if ($e.$5C()) {
                ...
                switch ($e.timeRangeSelectedHandling) {
                    case 'PostBack':
                        $e.timeRangeSelectedPostBack($v, end, $0N);
                        break;
                    case 'CallBack':
                        $e.timeRangeSelectedCallBack($v, end, $0N);
                        break;
                }
                ;
                ...
                switch ($e.timeRangeSelectedHandling) {
                    ...
                    case 'CallBack':
                        ...
                        break;
                    case 'JavaScript':
                        $e.onTimeRangeSelected($v, end, $0N);
                        break;
                    case 'Hold':
                        break;
                }
        ...
        this.timeRangeDoubleClickPostBack = function ($v, end, $0N, $m) {
            var $0O = {};
            $0O.start = $v;
            $0O.end = end;
            $0O.resource = $0N;
            this.$66('TimeRangeDoubleClick', $0O, $m);
        };
        this.timeRangeDoubleClickCallBack = function ($v, end, $0N, $m) {
            var $0O = {};
            $0O.start = $v;
            $0O.end = end;
            $0O.resource = $0N;
            this.$67('TimeRangeDoubleClick', $0O, $m);
        };
        this.$6I = function ($v, end, $0N) {
            if ($e.$5C()) {
                var $q = {};
                $q.start = $v;
                $q.end = end;
                ...
                switch ($e.timeRangeDoubleClickHandling) {
                    case 'PostBack':
                        $e.timeRangeDoubleClickPostBack($v, end, $0N);
                        break;
                    case 'CallBack':
                        $e.timeRangeDoubleClickCallBack($v, end, $0N);
                        break;
                }
                ;
                ...
                switch ($e.timeRangeDoubleClickHandling) {
                    ...
                    case 'CallBack':
                        ...
                        break;
                    case 'JavaScript':
                        $e.onTimeRangeDoubleClick($v, end, $0N);
                        break;
                }
            }
        };
        this.timeRangeMenuClickPostBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.selection = e;
            $0s.command = $0L;
            this.$66("TimeRangeMenuClick", $0s, $m);
        };
        this.timeRangeMenuClickCallBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.selection = e;
            $0s.command = $0L;
            this.$67("TimeRangeMenuClick", $0s, $m);
        };
        this.$6J = function ($0L, e, $0M) {
            switch ($0M) {
                case 'PostBack':
                    $e.timeRangeMenuClickPostBack(e, $0L);
                    break;
                case 'CallBack':
                    $e.timeRangeMenuClickCallBack(e, $0L);
                    break;
            }
        };
        this.resourceHeaderMenuClickPostBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.resource = e;
            $0s.command = $0L;
            this.$66("ResourceHeaderMenuClick", $0s, $m);
        };
        this.resourceHeaderMenuClickCallBack = function (e, $0L, $m) {
            var $0s = {};
            $0s.resource = e;
            $0s.command = $0L;
            this.$67("ResourceHeaderMenuClick", $0s, $m);
        };
        this.$6K = function ($0L, e, $0M) {
            switch ($0M) {
                case 'PostBack':
                    $e.resourceHeaderMenuClickPostBack(e, $0L);
                    break;
                case 'CallBack':
                    $e.resourceHeaderMenuClickCallBack(e, $0L);
                    break;
            }
        };
        this.resourceHeaderClickPostBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$66("ResourceHeaderClick", $0s, $m);
        };
        this.resourceHeaderClickCallBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$67("ResourceHeaderClick", $0s, $m);
        };
        this.$6L = function (e) {
            if ($e.$5C()) {
                var $q = {};
        ...
        this.timeHeaderClickPostBack = function (e, $m) {
            var $0s = {};
            $0s.header = e;
            this.$66("TimeHeaderClick", $0s, $m);
        };
        this.timeHeaderClickCallBack = function (e, $m) {
            var $0s = {};
            $0s.header = e;
            this.$67("TimeHeaderClick", $0s, $m);
        };
        this.$6M = function (e) {
            if ($e.$5C()) {
                var $q = {};
        ...
        this.resourceCollapsePostBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$66("ResourceCollapse", $0s, $m);
        };
        this.resourceCollapseCallBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$67("ResourceCollapse", $0s, $m);
        };
        this.$6N = function (e) {
            if ($e.$5C()) {
                var $q = {};
        ...
        this.resourceExpandPostBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$66("ResourceExpand", $0s, $m);
        };
        this.resourceExpandCallBack = function (e, $m) {
            var $0s = {};
            $0s.resource = e;
            this.$67("ResourceExpand", $0s, $m);
        };
        this.$6O = function (e) {
            if ($e.$5C()) {
                var $q = {};
        ...
        this.eventEditPostBack = function (e, $0P, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.newText = $0P;
            this.$66("EventEdit", $0s, $m);
        };
        this.eventEditCallBack = function (e, $0P, $m) {
            var $0s = {};
            $0s.e = e;
            $0s.newText = $0P;
            this.$67("EventEdit", $0s, $m);
        };
        this.$6P = function (e, $0P) {
            if ($e.$5C()) {
                var $q = {};
                $q.e = e;
                $q.newText = $0P;
                ...
                switch ($e.eventEditHandling) {
                    case 'PostBack':
                        $e.eventEditPostBack(e, $0P);
                        break;
                    case 'CallBack':
                        $e.eventEditCallBack(e, $0P);
                        break;
                    case 'Update':
                        e.text($0P);
                        $e.events.update(e);
        ...
        this.commandCallBack = function ($0L, $m) {
            this.$6Q("CallBack", $0L, $m);
        };
        this.commandPostBack = function ($0L, $m) {
            this.$6Q("PostBack", $0L, $m);
        };
        this.$6Q = function ($0w, $0L, $m) {
            var $0s = {};
            $0s.command = $0L;
            this.$6g($0w, "Command", $0s, $m);
        };
        this.$66 = function ($0y, $0Q, $m) {
            var $0R = {};
            $0R.action = $0y;
            $0R.type = "PostBack";
            $0R.parameters = $0Q;
            $0R.data = $m;
            $0R.header = this.$6R();
            var $0S = "JSON" + DayPilot.JSON.stringify($0R);
            __doPostBack($e.uniqueID, $0S);
        };
        this.$67 = function ($0y, $0Q, $m, $0w) {
            if (this.callbackTimeout) {
                window.clearTimeout(this.callbackTimeout);
            }
            ;
            ...
            $0R.data = $m;
            $0R.header = this.$6R();
            var $0T = DayPilot.JSON.stringify($0R);
            var $0S;
            if (typeof Iuppiter !== 'undefined' && Iuppiter.compress) {
                $0S = "LZJB" + Iuppiter.Base64.encode(Iuppiter.compress($0T));
            } else {
                $0S = "JSON" + $0T;
            }
            ;
            var $g = null;
            if (this.backendUrl) {
                DayPilot.request(this.backendUrl, this.$6U, $0S, this.$6V);
            } else if (typeof WebForm_DoCallback === 'function') {
                WebForm_DoCallback(this.uniqueID, $0S, this.$5a, $g, this.callbackError, true);
            }
        };
        this.$5T = function () {
            if (this.backendUrl) {
        ...
        this.$6R = function () {
            ...
            h.hashes = $e.hashes;
            var $u = $e.$6W(h.scrollX, h.scrollY);
            var $0O = $e.$6X($u);
            var $0W = $e.$6Y($u);
            h.rangeStart = $0O.start;
            h.rangeEnd = $0O.end;
            h.resources = $0W;
        ...
        this.$6W = function (scrollX, scrollY) {
            var $u = {};
            $u.start = {};
            $u.end = {};
            $u.start.x = Math.floor(scrollX / $e.cellWidth);
            $u.end.x = Math.floor((scrollX + $e.nav.scroll.clientWidth) / $e.cellWidth);
            $u.start.y = $e.$70(scrollY).i;
            $u.end.y = $e.$70(scrollY + $e.nav.scroll.clientHeight).i;
            var $0Y = this.itline.length;
            if ($u.end.x >= $0Y) {
                $u.end.x = $0Y - 1;
            }
            ;
        ...
        this.$6Y = function ($u) {
            if (!$u) {
                var $u = this.$6W(this.nav.scroll.scrollLeft, this.nav.scroll.scrollTop);
            }
            ;
            var $0W = [];
        ...
        this.$72 = function ($11) {
            var $12 = [];
            $12.ignoreToJSON = true;
            for (var i = 0; i < $11.length; i++) {
                $12.push(this.$71($11[i]));
            }
            ;
            return $12;
        };
        this.$71 = function (i) {
            ...
            var $10 = {};
            $10.Value = $t.Value;
            $10.BackColor = $t.BackColor;
            $10.Name = $t.Name;
            $10.InnerHTML = $t.InnerHTML;
            $10.ToolTip = $t.ToolTip;
            $10.Expanded = $t.Expanded;
            $10.Children = this.$72($t.Children);
            $10.Loaded = $t.Loaded;
            $10.IsParent = $t.IsParent;
            $10.Columns = this.$73($t);
            if ($t.MinHeight !== $e.rowMinHeight) {
                $10.MinHeight = $t.MinHeight;
            }
            ;
            if ($t.MarginBottom !== $e.rowMarginBottom) {
                $10.MarginBottom = $t.MarginBottom;
            }
            ;
            return $10;
        };
        ...
        this.$5L = function ($14) {
            var $15 = this.theme || this.cssClassPrefix;
            if ($15) {
                return $15 + $14;
            } else {
                return "";
        ...
        this.$74 = function () {
            var $16 = document.getElementById(id);
            $16.dispose = this.dispose;
        };
        this.dispose = function () {
            var c = $e;
            if (!c.nav.top) {
            ...
            c.nav.scroll.root = null;
            c.nav.scroll = null;
            DayPilot.ue(window, 'resize', c.$75);
            DayPilotScheduler.unregister(c);
        };
        this.$76 = function ($17, $0w) {
            var $18 = $e.maind;
            var $19 = $e.$77($17);
            var event = $17.event;
            var $P = event.part.height || $e.$78.eventHeight();
            var top = (event.part && event.part.top) ? (event.part.top + $e.rows[event.part.dayIndex].Top) : $19.top;
            var $1a = document.createElement('div');
            $1a.setAttribute('unselectable', 'on');
            $1a.style.position = 'absolute';
            $1a.style.width = ($19.width) + 'px';
            $1a.style.height = $P + 'px';
            $1a.style.left = $19.left + 'px';
            $1a.style.top = top + 'px';
            $1a.style.zIndex = 101;
            ...
            $1a.appendChild($E);
            if (this.cssOnly) {
                $1a.className = this.$5L("_shadow");
                $E.className = this.$5L("_shadow_inner");
            }
            ;
            if (!this.cssOnly) {
                if ($0w === 'Fill') {
                    ...
                    $E.style.height = "100%";
                    if ($17 && $17.event && $17.style) {
                        $E.style.fontSize = $17.style.fontSize;
                        $E.style.fontFamily = $17.style.fontFamily;
                        $E.style.color = $17.style.color;
                        $E.innerHTML = $17.event.client.innerHTML();
                    }
                } else {
                    $1a.style.paddingTop = "2px";
        ...
        this.$79 = function (i) {
            ...
            if (i > this.rows.length - 1) {
                throw "Row home too high (DayPilotScheduler._getRowByIndex)";
            }
            ;
            for (var j = 0; j <= i; j++) {
                var $t = this.rows[j];
        ...
        this.events.findRecurrent = function ($1f, $0k) {
            if (!$e.events.list || typeof $e.events.list.length === 'undefined') {
                return null;
            }
            ;
            var $1e = $e.events.list.length;
            for (var i = 0; i < $1e; i++) {
                if ($e.events.list[i].recurrentMasterId === $1f && $e.events.list[i].start.getTime() === $0k.getTime()) {
                    return new DayPilot.Event($e.events.list[i], $e);
                }
            }
            ;
        ...
        this.events.$6k = function ($m) {
            ...
            for (var i = 0; i < $e.rows.length; i++) {
                ...
                var ep = $e.$7c($m, $t);
                if (ep) {
                    var $1d = DayPilot.indexOf($e.events.list, ep.data);
                    $e.$7d($1d);
                    if (typeof $e.onBeforeEventRender === 'function') {
                        ep.cache = $e.$59.events[$1d];
                    }
                    ;
                    $0A.push(i);
                }
        ...
        this.events.remove = function (e, $m) {
            ...
            var $1d = DayPilot.indexOf($e.events.list, e.data);
            $e.events.list.splice($1d, 1);
            var $0A = $e.events.$6j(e.data);
            $e.$6l($0A);
            $e.$6m();
            $e.$6n($0A);
        ...
        this.cells.all = function () {
            var $0D = [];
            var $0Y = $e.itline.length;
            var $1h = $e.rows.length;
            for (var x = 0; x < $0Y; x++) {
                for (var y = 0; y < $1h; y++) {
        ...
        var $1g = function (a) {
            ...
            ;
            $0D.cssClass = function ($1i) {
                this.each(function ($1j) {
                    $1j.properties.cssClass = DayPilot.Util.addClassToString($1j.properties.cssClass, $1i);
                    $1j.update();
                });
                return this;
            };
            $0D.removeClass = function ($1i) {
                this.each(function ($1j) {
                    $1j.properties.cssClass = DayPilot.Util.removeClassFromString($1j.properties.cssClass, $1i);
                    $1j.update();
                });
                return this;
            };
        ...
        this.$7i = function ($r) {
            ...
            for (var i = 0; i < $e.rows.length; i++) {
                var $t = $e.rows[i];
                var $m = $t.element ? $t.element.data : $t.data;
                var $v = $m.start;
        ...
        this.$7j = function ($r) {
            ...
            ;
            var $1m = this.startDate;
            if ($r.ticks < this.startDate.ticks) {
                var $1n = this.itline[0].end.ticks - this.itline[0].start.ticks;
                while ($1m.ticks > $r.ticks) {
                    $1m = $1m.addTime(-$1n);
                }
                ;
                return $1m;
            ...
            if ($e.viewType === 'Days') {
                var $1o = this.$7i($r);
                var $0e = $1o.getTime() - $e.startDate.getTime();
                var $z = this.$63($r.addTime(-$0e));
                if ($z.current) {
                    return $z.current.start.addTime($0e);
                }
                ;
                if ($z.past) {
                    return $z.previous.end.addTime($0e);
                }
                ;
                ...
                ;
                if ($z.hidden) {
                    var $1p = $z.next.start.getTime() - $r.getTime();
                    var $1q = $z.next.end.getTime() - $z.next.start.getTime();
                    var $1r = Math.ceil($1p / $1q) * $1q;
                    var $f = $z.next.start.addTime(-$1r);
                    return $f;
                }
                ;
                throw "getBoxStart(): time not found";
        ...
        this.$77 = function ($17) {
            ...
            if ($e.scale === "Manual") {
                var $1v = (function () {
                    ...
                    var $1w = $e.getPixels($v).boxLeft;
                    var $1x = $e.getPixels(end).boxRight;
                    var end = Math.min($1x, $e.coords.x);
                    return end - $1w;
                })();
                var $0e = Math.min(DayPilotScheduler.moveOffsetX, $1v);
                x = $e.coords.x - $0e;
            }
            ;
            if ($1s) {
                var $z = $e.$63(e.start());
                var $1y = !$z.hidden && !$z.past;
                $1u = e.start().getTime() - this.$7j(e.start()).getTime();
                if ($1y) {
                    $1u = (function ($1z, $0e) {
                        var $1A = $e.$7k($e.$63($1z).current);
                        var $1B = $e.$7k($e.$61(x).cell);
                        if ($1A > $1B * 1.2) {
                            var $1C = $0e > 0 ? 1 : -1;
                            var $0e = Math.abs($0e);
                            while ($0e >= $1B) {
            ...
            if (DayPilotScheduler.moveDragStart && $e.scale !== "Manual") {
                if ($1s) {
                    $1D = DayPilotScheduler.moveDragStart.getTime() - this.$7j(e.start()).getTime();
                    var $1E = $e.$7l() * 60 * 1000;
                    $1D = Math.floor($1D / $1E) * $1E;
                } else {
                    $1D = DayPilotScheduler.moveDragStart.getTime() - e.start().getTime();
                }
            } else {
                $1D = 0;
            }
            ...
            ;
            var $v = this.getDate(x, true).addTime(-$1D);
            ...
            if (this.viewType === 'Days') {
                ...
                var $1F = $v.addTime(-$1H);
                var $1G = $1F.addTime($0l);
                var $1I = $t.element.data.start.getTime() - this.startDate.getTime();
                $v = $1F.addTime($1I);
                end = $v.addTime($0l);
            }
            ;
            ...
            var $x = ($1s) ? $1J.boxLeft : $1J.left;
            var $V = ($1s) ? ($1K.boxRight - $x) : ($1K.left - $x);
            var $19 = {};
            $19.top = $t.top;
            $19.left = $x;
            $19.row = $t.element;
        ...
        this.$7m = function (y) {
            return this.treePreventParentUsage && this.$7n(y);
        };
        this.$7n = function (y) {
            var $t = this.rows[y];
            if ($t.IsParent) {
        ...
        this.$7o = {};
        this.$7p = function () {
            var $19 = this.$77(DayPilotScheduler.moving);
            var y = $19.rowIndex;
            var $1L = this.$7n(y);
            var $1M = this.$7o;
            if ($1M.timeout && $1M.y !== y) {
                clearTimeout($1M.timeout);
                $1M.timeout = null;
            }
            ;
            if ($1L) {
                $1M.y = y;
                if (!$1M.timeout) {
                    $1M.timeout = setTimeout(function () {
                        var $1N = !$e.rows[$1M.y].Expanded;
                        if ($1N) {
                            $e.$7q($1M.y);
                            $e.$7r();
                        }
        ...
        this.$7r = function () {
            ...
            ;
            var $1a = DayPilotScheduler.movingShadow;
            var $19 = this.$77(DayPilotScheduler.moving);
            ...
            (function () {
                var y = $19.relativeY;
                var $t = $19.row;
                var $1P = $t.lines.length;
                var top = 0;
                var lh = $e.$78.eventHeight();
                var $1Q = $t.lines.length;
                for (var i = 0; i < $t.lines.length; i++) {
                    var $03 = $t.lines[i];
                    if ($03.isFree($19.left, $e.cellWidth)) {
                        $1Q = i;
                        break;
                    }
                }
                ...
                var $0j = Math.min($1Q, $0j);
                var $0j = Math.max(0, $0j);
                $1O = $0j;
            })();
            var $1R = (ev.cache && typeof ev.cache.moveVDisabled !== 'undefined') ? !ev.cache.moveVDisabled : !ev.data.moveVDisabled;
            var $1S = (ev.cache && typeof ev.cache.moveHDisabled !== 'undefined') ? !ev.cache.moveHDisabled : !ev.data.moveHDisabled;
            var $1T = $1O * $e.$78.eventHeight();
            if ($1T > 0) {
                $1T -= 3;
            }
            ;
            if ($1R) {
                if (!this.$7m($19.rowIndex)) {
                    $1a.row = $19.row;
                    $1a.style.height = Math.max($19.row.Height, 0) + 'px';
                    $1a.style.top = ($19.top) + 'px';
                    if ($e.eventMoveToPosition) {
                        $1a.style.top = ($19.top + $1T) + "px";
                        $1a.style.height = "3px";
                        $1a.line = $1O;
                    }
                } else {
                    var $1U = $1a.row;
                    var $1V = $19.rowIndex < $1U.Index ? 1 : -1;
                    for (var i = $19.rowIndex; i !== $1U.Index; i += $1V) {
                        var $t = this.rows[i];
                        if (!this.$7m(i) && !$t.Hidden) {
                            $1a.style.top = ($t.Top) + 'px';
                            $1a.style.height = Math.max($t.Height, 0) + 'px';
                            $1a.row = $t;
                            if ($e.eventMoveToPosition) {
                                $1O = $1V > 0 ? 0 : $t.lines.length - 1;
                                $1a.style.top = ($19.top + $1T) + "px";
                                $1a.style.height = "3px";
                                $1a.line = $1O;
                            }
                ...
                var $1U = this.rows[this.$70(parseInt($1a.style.top)).i];
                var $1Q = $1U.lines.length;
                for (var i = 0; i < $1U.lines.length; i++) {
                    var $03 = $1U.lines[i];
                    if ($03.isFree($19.left, $e.cellWidth)) {
                        $1Q = i;
                        break;
                ...
                ;
                $1a.style.height = Math.max($1U.Height, 0) + 'px';
                $1a.style.top = ($1U.Top) + 'px';
                $1a.row = $1U;
                if ($e.eventMoveToPosition) {
                    if ($19.row === $1U) {
                        $1a.style.top = ($1U.Top + $1T) + "px";
                        $1a.style.height = "3px";
                        $1a.line = $1O;
                    } else {
                        var $0j = ($19.rowIndex > $1U.Index && $1Q > 0) ? $1Q * $e.$78.eventHeight() - 3 : 0;
                        $1a.style.top = ($1U.Top + $0j) + "px";
                        $1a.style.height = "3px";
                        $1a.line = 0;
                    }
                }
            ...
            if (typeof $e.onEventMoving === 'function') {
                (function () {
                    var $0f = $e.$7s;
                    if ($0f && $0f.start.getTime() === $1a.start.getTime() && $0f.end.getTime() === $1a.end.getTime() && $0f.resource === $1a.row.Value) {
                        return;
                    }
                    ;
                    var $q = {};
                    ...
                    $q.end = $1a.end;
                    $q.e = ev;
                    $q.resource = $1a.row.Value;
                    $q.position = $1a.line;
                    $q.left = {};
                    $q.left.html = $q.start.toString("HH:mm");
                    $q.left.width = 90;
                    $q.right = {};
                    $q.right.html = $q.end.toString("HH:mm");
                    $q.right.width = 90;
                    $e.$7s = $q;
                    $e.onEventMoving($q);
                    $e.$7t($q);
        ...
        this.$7t = function ($q) {
            ...
            this.$7u();
            var $0j = {};
            $0j.left = parseInt($1a.style.left);
            $0j.top = parseInt($1a.style.top);
            $0j.right = $0j.left + parseInt($1a.style.width);
            var $x = document.createElement("div");
            $x.style.position = "absolute";
            $x.style.left = ($0j.left - $q.left.width - $1W) + "px";
            $x.style.top = $0j.top + "px";
            $x.style.height = $e.eventHeight + "px";
            $x.style.width = $q.left.width + "px";
            $x.style.overflow = "hidden";
            $x.innerHTML = $q.left.html;
            $x.className = this.$5L("_event_move_left");
            if ($q.left.visible) {
            ...
            $y.style.left = ($0j.right + $1W) + "px";
            $y.style.top = $0j.top + "px";
            $y.style.height = $e.eventHeight + "px";
            $y.style.width = $q.right.width + "px";
            $y.style.overflow = "hidden";
            $y.innerHTML = $q.right.html;
            $y.className = this.$5L("_event_move_right");
            if ($q.right.visible) {
        ...
        this.$7w = function () {
            ...
            ;
            var $1Y = this.divHeader;
            var $1Q = [];
            for (var i = 0; i < $1Y.rows.length; i++) {
                for (var j = 0; j < $1Y.rows[i].cells.length; j++) {
                    var $E = $1Y.rows[i].cells[j].firstChild.firstChild;
                    if (!$E || !$E.style) {
                        continue;
                    }
                    ;
                    var $1Z = $E.style.width;
                    var $20 = $E.style.right;
                    $E.style.position = "absolute";
                    $E.style.width = "auto";
                    $E.style.right = "auto";
                    ...
                    $E.style.right = $20;
                    $E.style.whiteSpace = "";
                    if (typeof $1Q[j] === 'undefined') {
                        $1Q[j] = 0;
                    }
                    ;
                    $1Q[j] = Math.max($1Q[j], w);
                }
            }
            ;
            var $21 = 0;
            ...
            if (this.rowHeaderCols) {
                for (var i = 0; i < $1Q.length; i++) {
                    if (this.rowHeaderCols[i]) {
                        if ($1Q[i] > this.rowHeaderCols[i]) {
                            this.rowHeaderCols[i] = $1Q[i];
                            $22 = true;
                        }
                        ;
                        $21 += this.rowHeaderCols[i];
                    }
                }
            } else {
                if (this.rowHeaderWidth < $1Q[0]) {
                    $21 = $1Q[0];
                    $22 = true;
                }
            }
        ...
        this.$5i = function () {
            ...
            parent.innerHTML = '';
            this.$7v();
            var $23 = this.rowHeaderCols;
            var $13 = $23 ? this.rowHeaderCols.length : 0;
            var $1X = this.$5O();
            var $1Y = document.createElement("table");
            $1Y.style.borderCollapse = "collapse";
            $1Y.style.KhtmlUserSelect = "none";
            $1Y.style.MozUserSelect = "none";
            $1Y.style.webkitUserSelect = "none";
            $1Y.style.width = $1X + "px";
            ...
            if (!this.cssOnly) {
                $1Y.className = this.$5L("resourceheader");
            }
            ;
            this.divHeader = $1Y;
            ...
            for (var i = 0; i < m; i++) {
                ...
                c.row = $t;
                c.index = i;
                var $V = $23 ? $23[0] : this.rowHeaderWidth;
                c.style.width = ($V) + "px";
                c.style.border = "0px none";
                if (!this.cssOnly) {
                ...
                c.onmousemove = $e.$7C;
                c.onmouseout = $e.$7D;
                c.oncontextmenu = $e.$7E;
                c.onclick = $e.$7F;
                var $B = document.createElement("div");
                $B.style.width = ($V) + "px";
                $B.setAttribute("unselectable", "on");
                $B.className = this.cssOnly ? this.$5L('_rowheader') : this.$5L('rowheader');
                if ($t.CssClass) {
                ...
                var $E = document.createElement("div");
                $E.setAttribute("unselectable", "on");
                $E.className = this.cssOnly ? this.$5L('_rowheader_inner') : "";
                $B.appendChild($E);
                ...
                $24.style.height = "1px";
                if (this.cssOnly) {
                    $24.className = this.$5L("_resourcedivider");
                } else {
                    $24.style.backgroundColor = this.borderColor;
                }
                ;
                $B.appendChild($24);
                if (this.treeEnabled) {
                    ...
                    $1M.style.width = "10px";
                    $1M.style.height = "10px";
                    $1M.style.backgroundRepeat = "no-repeat";
                    $1M.style.position = 'absolute';
                    $1M.style.left = ($t.Level * this.treeIndent + this.treeImageMarginLeft) + 'px';
                    $1M.style.top = this.treeImageMarginTop + "px";
                    if (!$t.Loaded && $t.Children.length === 0) {
                        if (this.treeImageExpand && !this.cssOnly) {
                            $1M.style.backgroundImage = "url('" + this.treeImageExpand + "')";
                        }
                        ;
                        $1M.className = this.cssOnly ? this.$5L('_tree_image_expand') : this.$5L('tree_image_expand');
                        $1M.style.cursor = 'pointer';
                        $1M.index = i;
                        $1M.onclick = function (ev) {
                            $e.$7G(this.index);
                            ev = ev || window.event;
                            ev.cancelBubble = true;
                        };
                        ...
                        if ($t.Expanded) {
                            if (this.treeImageCollapse && !this.cssOnly) {
                                $1M.style.backgroundImage = "url('" + this.treeImageCollapse + "')";
                            }
                            ;
                            $1M.className = this.cssOnly ? this.$5L('_tree_image_collapse') : this.$5L('tree_image_collapse');
                        } else {
                            if (this.treeImageExpand && !this.cssOnly) {
                                $1M.style.backgroundImage = "url('" + this.treeImageExpand + "')";
                            }
                        ...
                        if (this.treeImageNoChildren && !this.cssOnly) {
                            $1M.style.backgroundImage = "url('" + this.treeImageNoChildren + "')";
                        }
                        ;
                        $1M.className = this.cssOnly ? this.$5L('_tree_image_no_children') : this.$5L('tree_image_no_children');
                    }
                    ;
                    $E.appendChild($1M);
                }
                ...
                if (this.treeEnabled) {
                    $25.style.marginLeft = (($t.Level + 1) * this.treeIndent) + 'px';
                } else if (!this.cssOnly) {
                    $25.style.marginLeft = "4px";
                }
                ;
                $25.innerHTML = $t.InnerHTML;
                $E.appendChild($25);
                c.appendChild($B);
                if ($t.areas) {
                ...
                if (!$t.Columns || $t.Columns.length === 0) {
                    ...
                    for (var j = 1; j < $13; j++) {
                        ...
                        c.onclick = $e.$7F;
                        var $B = document.createElement("div");
                        var w = this.cssOnly ? $23[j] : $23[j] - 1;
                        if ($t.BackColor) {
                        ...
                        $B.setAttribute("unselectable", "on");
                        if (this.cssOnly) {
                            DayPilot.Util.addClass($B, this.$5L("_rowheader"));
                            DayPilot.Util.addClass($B, this.$5L("_rowheadercol"));
                            DayPilot.Util.addClass($B, this.$5L("_rowheadercol" + j));
                        }
                        ;
                        if ($t.CssClass) {
                            DayPilot.Util.addClass($B, $t.CssClass);
                        ...
                        $E.setAttribute("unselectable", "on");
                        if (this.cssOnly) {
                            $E.className = this.$5L("_rowheader_inner");
                        }
                        ;
                        $B.appendChild($E);
                        var $24 = document.createElement("div");
                        ...
                        ;
                        var $26 = $t.Columns[j - 1] ? $t.Columns[j - 1].html : "";
                        $25.innerHTML = $26;
                        $E.appendChild($25);
                        c.appendChild($B);
                    }
            ...
            if (this.cssOnly) {
                ...
                $B.style.position = "relative";
                $B.style.height = "100%";
                $B.className = this.$5L('_rowheader');
                c.appendChild($B);
            }
            ;
            parent.appendChild($1Y);
        ...
        this.$7b = function (i) {
            ...
            $t.data.end = $04.isResourcesView() ? this.$7J() : $t.data.start.addDays(1);
            $t.data.endTicks = $t.data.end.getTime();
            $t.data.offset = $t.Start.getTime() - this.$7K().getTime();
            $t.data.i = i;
        };
        this.$5h = function ($0B, $28) {
            var $29 = [];
            var $k = [];
            var $1l = null;
            if ($0B && $28) {
                ...
                ;
                this.events.list = this.events.list.concat($1l);
            } else if ($0B) {
                this.events.list = $0B;
            ...
            ;
            var $0D = $1l || this.events.list;
            var $2b = $0D.length;
            if (typeof this.onBeforeEventRender === 'function') {
                var $v = $1l ? this.events.list.length - $1l.length : 0;
            ...
            for (var i = 0; i < this.rows.length; i++) {
                var $t = this.rows[i];
                if (!$1l || typeof $t.events === "undefined") {
                    $t.events = [];
                }
                ;
                $e.$7b(i);
        ...
        this.$7M = function ($t) {
            ...
            if (this.sortDirections) {
                $t.events.sort(this.$7N);
            } else {
                $t.events.sort(this.$7O);
            }
            ;
        ...
        this.$7c = function (e, $t) {
            ...
            switch (this.viewType) {
                case 'Days':
                    $2h = !($2g <= $t.data.startTicks || $2f >= $t.data.endTicks) || ($2f === $2g && $2f === $t.data.startTicks);
                    break;
                case 'Resources':
                    $2h = ($t.Value === e.resource || $t.Value === "*" || e.resource === "*") && (!($2g <= $t.data.startTicks || $2f >= $t.data.endTicks) || ($2f === $2g && $2f === $t.data.startTicks));
                    break;
                case 'Gantt':
                    $2h = ($t.Value === e.id) && !($2g <= $t.data.startTicks || $2f >= $t.data.endTicks);
                    break;
            }
            ;
            if (!$2h) {
            ...
            ep.part.start = $t.data.startTicks < $2f ? ep.start() : $t.data.start;
            ep.part.end = $t.data.endTicks > $2g ? ep.end() : $t.data.end;
            var $2i = this.getPixels(ep.part.start.addTime(-$t.data.offset));
            var $2j = this.getPixels(ep.part.end.addTime(-$t.data.offset));
            var $x = $2i.left;
            var $y = $2j.left;
            if ($x === $y && ($2i.cut || $2j.cut)) {
                return null;
            }
            ;
            ep.part.box = $04.useBox($2g - $2f);
            if (ep.part.box) {
                var $2k = $2i.boxLeft;
                var $2l = $2j.boxRight;
                ep.part.left = $2k;
        ...
        this.$7O = function (a, b) {
            ...
            ;
            var $2m = a.start().ticks - b.start().ticks;
            if ($2m !== 0) {
                return $2m;
            }
            ;
            var $2n = b.end().ticks - a.end().ticks;
            return $2n;
        };
        this.$7N = function (a, b) {
            ...
            while ($f === 0 && a.data.sort[i] && b.data.sort[i]) {
                if (a.data.sort[i] === b.data.sort[i]) {
                    ...
                    $f = $e.$7P(a.data.sort[i], b.data.sort[i], $e.sortDirections[i]);
                }
                ;
                i++;
            }
        ...
        this.$5f = function () {
            ...
            var $1d = {};
            $1d.i = 0;
            this.$7S($0X, $1d, 0, null, this.treeEnabled, false);
        };
        this.$7Q = function () {
            var $0D = [];
        ...
        this.$7R = function () {
            var $0D = [];
            var $2t = this.$78.locale();
            for (var i = 0; i < this.days; i++) {
                var d = this.startDate.addDays(i);
                var r = {};
                r.name = d.toString($2t.datePattern, $2t);
                r.start = d;
                $0D.push(r);
            }
            ;
        ...
        this.$7S = function ($0X, $1d, $2u, parent, $2v, $2w) {
            if (!$0X) {
                return;
            }
            ;
            for (var i = 0; i < $0X.length; i++) {
                ...
                $2x.hidden = $2w;
                $2x.index = $1d.i;
                var $0W = this.$7T($0X[i], $2x);
                var $t = {};
                $t.BackColor = $0W.backColor;
                $t.CssClass = $0W.cssClass;
                $t.Expanded = $0W.expanded;
                $t.Name = $0W.name;
                $t.InnerHTML = $0W.html ? $0W.html : $t.Name;
                $t.MinHeight = typeof $0W.minHeight !== 'undefined' ? $0W.minHeight : $e.rowMinHeight;
                $t.MarginBottom = typeof $0W.marginBottom !== 'undefined' ? $0W.marginBottom : $e.rowMarginBottom;
                $t.Loaded = !$0W.dynamicChildren;
                $t.Value = $0W.id || $0W.value;
                $t.ToolTip = $0W.toolTip;
                $t.Children = [];
                $t.Columns = [];
                $t.Start = $0W.start ? new DayPilot.Date($0W.start) : this.$7K();
                $t.IsParent = $0W.isParent;
                $t.contextMenu = $0W.contextMenu ? eval($0W.contextMenu) : this.contextMenuResource;
                $t.areas = $0W.areas;
                $t.Height = this.$78.eventHeight();
                $t.Hidden = $2w;
                $t.Level = $2u;
                $t.Index = $1d.i;
                $t.Resource = $0X[i];
                ...
                $t.isRow = true;
                $t.height = function () {
                    var $2y = Math.max(1, this.lines.length);
                    var $2z = $e.durationBarDetached ? ($e.$78.eventHeight() + 10) : $e.$78.eventHeight();
                    var $P = $2y * $2z + this.MarginBottom;
                ...
                $t.putIntoLine = function (ep) {
                    ...
                    ;
                    var $03 = [];
                    $03.isFree = function ($2B, $2C) {
                        var end = $2B + $2C - 1;
                        var $1Q = this.length;
                        for (var i = 0; i < $1Q; i++) {
                            var e = this[i];
                            if (!(end < e.part.left || $2B > e.part.left + e.part.width - 1)) {
                                return false;
                            }
                        }
                        ;
                ...
                this.rows.push($t);
                if (parent !== null) {
                    parent.Children.push($1d.i);
                }
                ;
                if ($0W.columns) {
                    for (var j = 0; j < $0W.columns.length; j++) {
                        $t.Columns.push($0W.columns[j]);
                    }
                }
                ;
                $1d.i++;
                if ($2v && $0W.children && $0W.children.length) {
                    this.hasChildren = true;
                    var $2D = $2w || !$t.Expanded;
                    this.$7S($0W.children, $1d, $2u + 1, $t, true, $2D);
                }
            }
        };
        this.$7T = function ($0W, $2x) {
            var r = {};
            for (var name in $0W) {
                r[name] = $0W[name];
            }
            ;
            if (typeof $0W.html === 'undefined') {
                r.html = $0W.name;
            }
            ;
            for (var name in $2x) {
        ...
        this.$7U = function () {
            ...
            if (!this.cssOnly) {
                ...
                DayPilot.Util.addClass(this.nav.top, this.$5L("_main"));
            }
            ;
            this.nav.top.style.MozUserSelect = 'none';
            this.nav.top.style.KhtmlUserSelect = 'none';
            ...
            ;
            var $2E = this.$5O();
            var $2F = this.$78.layout();
            if ($2F === 'DivBased') {
                var $x = document.createElement("div");
                $x.style.position = "absolute";
                $x.style.left = "0px";
                $x.style.width = ($2E) + "px";
                $x.appendChild(this.$7V());
                var $2G = document.createElement("div");
                $2G.style.height = "1px";
                $2G.className = this.$5L("_divider_horizontal");
                if (!this.cssOnly) {
                ...
                $x.appendChild($2G);
                this.nav.dh1 = $2G;
                $x.appendChild(this.$7W());
                this.nav.left = $x;
                var $2H = document.createElement("div");
                $2H.style.position = "absolute";
                $2H.style.left = ($2E) + "px";
                $2H.style.width = "1px";
                $2H.style.height = (this.$5N() + this.$5Q()) + "px";
                $2H.className = this.$5L("_divider");
                if (!this.cssOnly) {
                    $2H.style.backgroundColor = this.borderColor;
                }
                ;
                this.nav.divider = $2H;
                var $y = document.createElement("div");
                $y.style.marginLeft = ($2E + 1) + "px";
                $y.style.marginRight = '1px';
                $y.style.position = 'relative';
                $y.appendChild(this.$7X());
                this.nav.right = $y;
                var $2I = document.createElement("div");
                $2I.style.height = "1px";
                $2I.style.position = "absolute";
                $2I.style.top = this.$5N() + "px";
                $2I.style.width = "100%";
                $2I.className = this.$5L("_divider_horizontal");
                if (!this.cssOnly) {
                    $2I.style.backgroundColor = this.borderColor;
                }
                ;
                $y.appendChild($2I);
                this.nav.dh2 = $2I;
                $y.appendChild(this.$7Y());
                var $2J = document.createElement("div");
                $2J.style.clear = 'left';
                this.nav.top.appendChild($x);
                this.nav.top.appendChild($2H);
                this.nav.top.appendChild($y);
                this.nav.top.appendChild($2J);
            } else {
                var $1Y = document.createElement("table");
                $1Y.cellPadding = 0;
                $1Y.cellSpacing = 0;
                ...
                if (!this.cssOnly) {
                    $1Y.style.backgroundColor = this.hourNameBackColor;
                }
                ;
                var $2K = $1Y.insertRow(-1);
                var $2L = $2K.insertCell(-1);
                $2L.appendChild(this.$7V());
                var $2M = $2K.insertCell(-1);
                $2M.appendChild(this.$7X());
                var $2N = $1Y.insertRow(-1);
                var $2O = $2N.insertCell(-1);
                $2O.appendChild(this.$7W());
                var $2P = $2N.insertCell(-1);
                $2P.appendChild(this.$7Y());
                this.nav.top.appendChild($1Y);
            }
            ;
            this.vsph = document.createElement("div");
            this.vsph.style.display = "none";
            this.nav.top.appendChild(this.vsph);
            var $2Q = document.createElement("input");
            $2Q.type = "hidden";
            $2Q.id = this.id + "_state";
            $2Q.name = this.id + "_state";
            this.nav.state = $2Q;
            this.nav.top.appendChild($2Q);
            var loading = document.createElement("div");
            loading.style.position = 'absolute';
            loading.style.left = (this.$5O() + 5) + "px";
            loading.style.top = (this.$5N() + 5) + "px";
            ...
            DayPilot.Util.addClass(loading, this.$5L("_loading"));
        ...
        this.$7z = function () {
            ...
            this.nav.right.style.marginLeft = ($V + 1) + "px";
            if (this.nav.message) {
                this.nav.message.style.paddingLeft = $V + "px";
            }
            ;
            if (this.nav.loading) {
                this.nav.loading.style.left = ($V + 5) + "px";
            }
            ;
            var $2R = function ($E, $V) {
                if (!$E || !$E.style) {
            ...
            $1Y.style.width = $V + "px";
            for (var i = 0; i < $1Y.rows.length; i++) {
                var $z = $1Y.rows[i].cells[0];
                if ($z.colSpan > 1) {
                    var $E = $1Y.rows[i].cells[0].firstChild;
                    $2R($E, $R);
                } else {
                    if (this.rowHeaderCols) {
                        for (var j = 0; j < $1Y.rows[i].cells.length; j++) {
                            var $V = this.rowHeaderCols[j];
                            var $E = $1Y.rows[i].cells[j].firstChild;
                            $2R($E, $V);
                        }
                    } else {
        ...
        this.$80 = function () {
            ...
            $t.className = this.$5L("_columnheader");
            $B.appendChild($t);
            var $E = document.createElement("div");
            $E.style.position = "absolute";
            $E.style.top = "0px";
            ...
            $E.style.left = "0px";
            $E.style.right = "0px";
            $E.className = this.$5L("_columnheader_inner");
            $t.appendChild($E);
            var $2T = new DayPilot.Splitter($E);
            $2T.widths = DayPilot.Util.propArray($2S, "width");
            $2T.height = $04.headerHeight();
            $2T.css.title = this.$5L("_columnheader_cell");
            $2T.css.titleInner = this.$5L("_columnheader_cell_inner");
            $2T.css.splitter = this.$5L("_columnheader_splitter");
            $2T.titles = DayPilot.Util.propArray($2S, "title");
            $2T.updating = function ($q) {
        ...
        this.$6z = function () {
            ...
            $B.innerHTML = '';
            $B.className = this.cssOnly ? this.$5L('_corner') : this.$5L('corner');
            if (!this.cssOnly) {
            ...
            $E.style.bottom = "0px";
            if (this.cssOnly) {
                $E.className = this.$5L('_corner_inner');
            }
            ;
            this.divCorner = $E;
            $E.innerHTML = '&nbsp;';
            if (this.rowHeaderColumns && this.rowHeaderColumns.length > 0) {
                ...
                $2U.style.left = "0px";
                $2U.style.right = "0px";
                $2U.style.bottom = ($04.headerHeight() + 1) + "px";
                $B.appendChild($2U);
                var $2H = document.createElement("div");
                $2H.style.position = "absolute";
                $2H.style.left = "0px";
                $2H.style.right = "0px";
                $2H.style.height = "1px";
                $2H.style.bottom = ($04.headerHeight()) + "px";
                $2H.className = this.$5L("_divider");
                $B.appendChild($2H);
                $2U.appendChild($E);
                this.$80();
            ...
            var $2V = document.createElement("div");
//            $2V.style.position = 'absolute';
            $2V.style.padding = '2px';
            $2V.style.top = '0px';
            $2V.style.left = '1px';
            $2V.style.backgroundColor = "#FF6600";
            $2V.style.color = "white";
//            $2V.innerHTML = "\u0044\u0045\u004D\u004F";
            if (this.numberFormat)$B.appendChild($2V);
        };
        this.$7V = function () {
            var $2E = this.$5O();
            var $B = document.createElement("div");
        ...
        this.$5N = function () {
            if (this.timeHeader) {
                var $2W = this.timeHeader.length;
                if (!this.showBaseTimeHeader) {
                    $2W -= 1;
                }
                ;
                return $2W * $04.headerHeight();
            }
            ;
        ...
        this.$7W = function () {
            ...
            ;
            $B.style.width = (this.$5O()) + "px";
            $B.style.height = this.$5Q() + "px";
            $B.style.overflow = 'hidden';
            $B.style.position = 'relative';
            $B.onmousemove = function () {
                $e.$7B();
        ...
        this.$81 = function ($B) {
            if ($04.layout() === 'TableBased') {
                ...
                var $2X = (this.width.indexOf("%") !== -1);
                var $2Y = /MSIE/i.test(navigator.userAgent);
                var $2E = this.$5O();
                if ($2X) {
                    if (this.nav.top && this.nav.top.offsetWidth > 0) {
                        $B.style.width = (this.nav.top.offsetWidth - 6 - $2E) + "px";
                    }
                } else {
                    $B.style.width = ($V - $2E) + "px";
                }
            }
        };
        this.$75 = function () {
            if ($e.$78.layout() === 'TableBased') {
                $e.$81($e.nav.scroll);
                $e.$81($e.divTimeScroll);
            }
            ;
            $e.$5o();
            $e.$7A();
        ...
        this.$7X = function () {
            ...
            var $E = document.createElement("div");
            $E.style.width = (this.$5M() * this.cellWidth + 5000) + "px";
            this.divNorth = $E;
            $B.appendChild($E);
            return $B;
        };
        ...
        this.$82 = function () {
            ...
            if (this.innerHeightTree) {
                var $32 = DayPilot.sh($e.nav.scroll);
                if ($32 === 0) {
                    $P = this.innerHeightTree;
                } else {
                    $P = this.innerHeightTree + $32;
                }
            } else {
                $P = this.rows.length * this.$78.eventHeight();
            }
            ;
            return $P;
        };
        ...
        this.$7Y = function () {
            ...
            $B.style.position = "absolute";
            $B.style.height = (this.$5Q()) + "px";
            $B.style.top = (this.$5N() + 1) + "px";
            $B.style.width = "100%";
            if (!this.cssOnly) {
                $B.style.backgroundColor = this.emptyBackColor;
            }
            ;
            $B.className = this.$5L("_scrollable");
            $B.oncontextmenu = function () {
                return false;
            };
            this.$81($B);
            ...
            var $33 = this.$85();
            if ($33 > 0 && !isNaN($33)) {
                this.maind.style.width = ($33) + "px";
            }
            ;
            this.maind.setAttribute("unselectable", "on");
            this.maind.onmousedown = this.$86;
            this.maind.onmousemove = this.$87;
            this.maind.oncontextmenu = this.$88;
            this.maind.ondblclick = this.$89;
            this.maind.className = this.$5L("_matrix");
            ...
            this.divSeparators.oncontextmenu = this.$88;
            ...
            this.divSeparatorsAbove.oncontextmenu = this.$88;
        ...
        this.$5A = function ($35) {
            ...
            ;
            this.$6S();
            var $36 = this.autoRefreshInterval;
            if (!$36 || $36 < 10) {
                throw "The minimum autoRefreshInterval is 10 seconds";
            }
            ;
        ...
        this.$8d = function () {
            ...
            ;
            DayPilot.re(window, 'resize', this.$75);
        };
        this.$8e = function () {
            this.nav.scroll.root = this;
            this.nav.scroll.onscroll = this.$8f;
        ...
        this.$5x = function () {
            var $v = new Date();
            var $38 = {};
            $38.scrollX = this.nav.scroll.scrollLeft;
            $38.scrollY = this.nav.scroll.scrollTop;
            if (this.syncResourceTree) {
                $38.tree = this.$6Z();
            }
            ;
            this.nav.state.value = DayPilot.he(DayPilot.JSON.stringify($38));
            var end = new Date();
        };
        this.$5t = function () {
            if (!this.separators) {
        ...
        this.$5u = function ($0J) {
            var $39 = this.batch.step;
            var $3a = this.batch.layers;
            if ($3a) {
                $e.divEvents = document.createElement("div");
                $e.divEvents.style.position = 'absolute';
                $e.maind.insertBefore(this.divEvents, this.divSeparatorsAbove);
            } else {
            }
            ;
            ...
            ;
            var $3b = this.dynamicEventRendering === 'Progressive';
            var $u = this.$5G();
            var top = $u.pixels.top;
            var $M = $u.pixels.bottom;
            var $3c = this.durationBarDetached ? 10 : 0;
            if (this.clientSide) {
                for (var i = 0; i < this.rows.length; i++) {
                    var $t = this.rows[i];
                    var $3d = $t.Top - this.dynamicEventRenderingMargin;
                    var $3e = $3d + $t.Height + 2 * this.dynamicEventRenderingMargin;
                    if ($3b && ($M <= $3d || top >= $3e)) {
                        continue;
                    }
                    ;
                    for (var j = 0; j < $t.lines.length; j++) {
                        ...
                        for (var k = 0; k < $03.length; k++) {
                            ...
                            if (!e.part.top) {
                                e.part.line = j;
                                e.part.top = j * (this.$78.eventHeight() + $3c) + $3c;
                                e.part.detachedBarTop = e.part.top - $3c;
                                e.part.height = this.$78.eventHeight();
                ...
                var $3g = this.events.list.length;
                for (var i = 0; i < $3g; i++) {
                    this.$8h(this.events.list[i]);
                }
            }
            ;
            this.divEvents.style.display = '';
        ...
        this.$6A = function ($3h) {
            if (this.elements.events) {
                ...
                ;
                for (var i = $3i.length - 1; i >= 0; i--) {
                    this.elements.events.splice($3i[i], 1);
                }
            }
        };
        this.$8i = function ($B) {
        ...
        this.$8l = function ($3j) {
            ...
            for (var i = length - 1; i >= 0; i--) {
                ...
                var $3m = ($u.xStart < $B.coords.x && $B.coords.x <= $u.xEnd) && ($u.yStart < $B.coords.y && $B.coords.y <= $u.yEnd);
                if (!$3m) {
                    if ($3j > 0) {
                        $3j--;
                        $3k.unshift($B);
        ...
        this.$7e = function ($B) {
            ...
            var x = $B.coords.x;
            var y = $B.coords.y;
            var $1d = DayPilot.indexOf($e.elements.cells, $B);
            $e.elements.cells.splice($1d, 1);
            if ($B.parentNode) {
                $B.parentNode.removeChild($B);
            }
            ;
            $e.$59.cells[x + "_" + y] = null;
        };
        this.$5r = function () {
        ...
        this.$8k = function (ev) {
            ...
            var $y = $x + this.nav.scroll.clientWidth;
            var $3n = ev.part.left;
            var $3o = ev.part.right;
            var $3p = ev.part.fullTop;
            var $3q = ev.part.fullBottom;
            if ($y <= $3n || $x >= $3o) {
                return true;
            }
            ;
        ...
        this.$8h = function ($m) {
            ...
            ;
            var $3b = this.dynamicEventRendering === 'Progressive' && !this.dynamicLoading;
            var $u = this.$5G();
            var $x = $u.pixels.left;
            var $y = $u.pixels.right;
            var $3n = $m.part.left;
            var $3o = $m.part.left + $m.part.width;
            if ($3b && ($y <= $3n || $x >= $3o)) {
                return false;
            }
            ;
            var $3h = $m.part.dayIndex;
            var $3r = !this.cssOnly && this.eventBorderVisible;
            var $V = $m.part.width;
            var $P = $m.part.height;
            if ($3r) {
                $V -= 2;
            ...
            var $3d = $t.Top;
            var $B = document.createElement("div");
            var $3s = this.durationBarDetached;
            if ($3s) {
                var $3t = document.createElement("div");
                $3t.style.position = 'absolute';
                $3t.style.left = ($m.part.left + $m.part.barLeft) + 'px';
                $3t.style.top = ($3d + $m.part.detachedBarTop) + 'px';
                $3t.style.width = $m.part.barWidth + 'px';
                $3t.style.height = 5 + 'px';
                $3t.style.backgroundColor = "red";
                $B.bar = $3t;
                this.elements.bars.push($3t);
                this.divEvents.appendChild($3t);
            }
            ;
            var top = $3d + $m.part.top;
            $B.style.position = 'absolute';
            $B.style.left = $m.part.left + 'px';
            $B.style.top = ($3d + $m.part.top) + 'px';
            $B.style.width = $V + 'px';
            $B.style.height = $P + 'px';
            if (!this.cssOnly) {
            ...
            $B.style.overflow = 'hidden';
            $B.className = this.cssOnly ? this.$5L("_event") : this.$5L("event");
            if ($08.cssClass) {
            ...
            var $3u = true;
            if ($3u) {
                DayPilot.Util.addClass($B, this.$5L("_event_line" + $m.part.line));
            }
            ;
            $B.setAttribute("unselectable", "on");
            if (this.showToolTip && !this.bubble) {
            ...
            ;
            $B.onmousemove = this.$8o;
            $B.onmouseout = this.$8p;
            $B.onmousedown = this.$8q;
            ...
            if ($m.client.doubleClickEnabled()) {
                $B.ondblclick = this.$6e;
            }
            ;
            $B.oncontextmenu = this.$6d;
            var $3v = [];
            var $3w = 0;
            if (this.cssOnly) {
                var $E = document.createElement("div");
                $E.setAttribute("unselectable", "on");
                $E.className = $e.$5L("_event_inner");
                ...
                ;
                $B.appendChild($E);
                var $3x = $m.start().getTime() === $m.part.start.getTime();
                var $3y = $m.end().getTime() === $m.part.end.getTime();
                if (!$3x) {
                    DayPilot.Util.addClass($B, this.$5L("_event_continueleft"));
                }
                ;
                if (!$3y) {
                    DayPilot.Util.addClass($B, this.$5L("_event_continueright"));
                }
                ;
                if ($m.client.barVisible() && $V > 0) {
                    var $3z = 100 * $m.part.barLeft / ($V);
                    var $3A = Math.ceil(100 * $m.part.barWidth / ($V));
                    if (this.durationBarMode === "PercentComplete") {
                        $3z = 0;
                        $3A = $08.complete;
                    }
                    ...
                    $3t.className = this.$5L("_event_bar");
                    $3t.style.position = "absolute";
                    var $3B = document.createElement("div");
                    $3B.setAttribute("unselectable", "on");
                    $3B.className = this.$5L("_event_bar_inner");
                    $3B.style.left = $3z + "%";
                    if (0 < $3A && $3A <= 1) {
                        $3B.style.width = "1px";
                    } else {
                    ...
                    ;
                    if ($08.barColor) {
                        $3B.style.backgroundColor = $08.barColor;
                    }
                    ;
                    $3t.appendChild($3B);
                    $B.appendChild($3t);
                ...
                if ($m.client.barVisible()) {
                    $3w = $e.durationBarHeight;
                    $3v.push("<div unselectable='on' style='left:0px;background-color:white;width:");
                    $3v.push($m.part.barLeft);
                    $3v.push("px;height:2px;font-size:1px;position:absolute'></div>");
                    $3v.push("<div unselectable='on' style='left:");
                    $3v.push($m.part.barLeft + $m.part.barWidth);
                    $3v.push("px;background-color:white;width:");
                    $3v.push($V - ($m.part.barLeft + $m.part.barWidth));
                    $3v.push("px;height:2px;font-size:1px;position:absolute'></div>");
                    if (this.durationBarMode === "Duration") {
                        $3v.push("<div unselectable='on' style='width:");
                        $3v.push($m.part.barWidth);
                        $3v.push("px;margin-left:");
                        $3v.push($m.part.barLeft);
                        $3v.push("px;height:");
                    } else {
                        $3v.push("<div unselectable='on' style='width:");
                        $3v.push($08.complete);
                        $3v.push("%;margin-left:0px;height:");
                    }
                    ;
                    $3v.push($3w - 1);
                    $3v.push("px;background-color:");
                    $3v.push($m.client.barColor());
                    if ($08.barImageUrl) {
                        $3v.push(";background-image:url(");
                        $3v.push($08.barImageUrl);
                        $3v.push(")");
                    }
                    ;
                    $3v.push(";font-size:1px;position:relative'></div>");
                    $3v.push("<div unselectable='on' style='width:");
                    $3v.push($V);
                    $3v.push("px;height:1px;background-color:");
                    $3v.push(($08.borderColor || this.eventBorderColor));
                    $3v.push(";font-size:1px;overflow:hidden;position:relative'></div>");
                }
                ;
                $3v.push("<div unselectable='on' style='padding-left:1px;width:");
                $3v.push($V - 1);
                $3v.push("px;height:");
                $3v.push($P - $3w);
                $3v.push("px;");
                if ($e.rtl) {
                    $3v.push("direction:rtl;");
                }
                ;
                if ($08.backImage && this.durationBarVisible) {
                    $3v.push("background-image:url(");
                    $3v.push($08.backImage);
                    $3v.push(");");
                    if ($08.backRepeat) {
                        $3v.push("background-repeat:");
                        $3v.push($08.backRepeat);
                        $3v.push(";");
                    }
                }
                ;
                $3v.push("'>");
                $3v.push($m.client.innerHTML());
                $3v.push("</div>");
                $B.innerHTML = $3v.join('');
            }
            ;
        ...
        this.$6C = function () {
            for (var i = 0; i < this.elements.events.length; i++) {
                var $B = this.elements.events[i];
                var event = $B.event;
                var $3h = event.part.dayIndex;
                var $t = this.rows[$3h];
                var $3d = $t.Top;
                $B.style.top = ($3d + event.part.top) + 'px';
            }
        };
        this.$8r = function (e) {
            for (var i = 0; i < $e.elements.events.length; i++) {
        ...
        this.$8p = function (ev) {
            ...
            if ($e.cssOnly) {
                DayPilot.Util.removeClass($B, $e.$5L("_event_hover"));
            }
            ;
        ...
        this.$8o = function (ev) {
            ...
            if (!$B.active) {
                ...
                if ($e.cssOnly) {
                    DayPilot.Util.addClass($B, $e.$5L("_event_hover"));
                }
            }
            ;
            if (ev.srcElement) {
        ...
        $0m.onMainTouchMove = function (ev) {
            ...
            if ($0m.active) {
                ...
                if ($0m.range) {
                    var $0O = $0m.range;
                    $0O.end = {x: Math.floor($e.coords.x / $e.cellWidth)};
                    $e.$8w($0O);
                }
            }
        };
        $0m.onMainTouchEnd = function (ev) {
            ...
            if ($0m.active) {
                if (DayPilotScheduler.moving) {
                    ...
                    $e.$6D(e, $0u, $0v, $0x, external);
                }
                ;
                if ($0m.range) {
                    var $3E = $e.$8x($0m.range);
                    $0m.range = null;
                    $e.$6H($3E.start, $3E.end, $3E.resource);
                }
            }
            ;
            window.setTimeout(function () {
        ...
        $0m.relativeCoords = function (ev) {
            ...
            var x = ev.touches[0].pageX;
            var y = ev.touches[0].pageY;
            var $3G = DayPilot.abs($3F);
            var $19 = {x: x - $3G.x, y: y - $3G.y, toString: function () {
                return "x: " + this.x + ", y:" + this.y;
            }};
            return $19;
        };
        $0m.startMoving = function ($B, ev) {
            var $19 = {x: ev.touches[0].pageX, y: ev.touches[0].pageY};
            DayPilotScheduler.moving = $B;
            DayPilotScheduler.originalMouse = $19;
            var $3H = DayPilot.abs($B);
            DayPilotScheduler.moveOffsetX = $19.x - $3H.x;
            DayPilotScheduler.moveDragStart = $e.getDate($e.coords.x, true);
            DayPilotScheduler.movingShadow = $e.$76($B, $e.shadow);
            $e.$7r();
        };
        $0m.updateMoving = function () {
            ...
            if (!DayPilotScheduler.movingShadow) {
                ...
                DayPilotScheduler.movingShadow = $e.$76(mv, $e.shadow);
            }
            ;
            DayPilotScheduler.moving.target = $e;
            $e.$7r();
        };
        this.$8s = function ($B, ev) {
            var $3I = this.eventResizeMargin;
            var $3J = this.eventMoveMargin;
            var $17 = $B;
            if (typeof(DayPilotScheduler) === 'undefined') {
                return;
            }
            ...
            ;
            var $3K = $B.getAttribute("dpStart") === $B.getAttribute("dpPartStart");
            var $3L = $B.getAttribute("dpEnd") === $B.getAttribute("dpPartEnd");
            if ($e.moveBy === 'Top' && $0e.y <= $3J && $17.event.client.moveEnabled() && $e.eventMoveHandling !== 'Disabled') {
                if ($3K) {
                    $B.style.cursor = 'move';
                } else {
                    $B.style.cursor = 'not-allowed';
                }
            } else if (($e.moveBy === 'Top' || $e.moveBy === 'Full') && $0e.x <= $3I && $17.event.client.resizeEnabled() && $e.eventResizeHandling !== 'Disabled') {
                if ($3K) {
            ...
            } else if ($e.moveBy === 'Left' && $0e.x <= $3J && $17.event.client.moveEnabled() && $e.eventMoveHandling !== 'Disabled') {
                if ($3K) {
                    $B.style.cursor = "move";
                } else {
                    $B.style.cursor = 'not-allowed';
                }
            } else if ($B.offsetWidth - $0e.x <= $3I && $17.event.client.resizeEnabled() && $e.eventResizeHandling !== 'Disabled') {
                if ($3L) {
                ...
                if ($17.event.client.clickEnabled() && $e.eventClickHandling !== 'Disabled') {
            ...
            if (typeof(DayPilotBubble) !== 'undefined' && $e.bubble && $e.eventHoverHandling === 'Bubble') {
                if ($B.style.cursor === 'default' || $B.style.cursor === 'pointer') {
                    var $3M = this.$8y && $0e.x === this.$8y.x && $0e.y === this.$8y.y;
                    if (!$3M) {
                        this.$8y = $0e;
        ...
        this.$8x = function ($0O) {
            var $0O = $0O || DayPilotScheduler.range || DayPilotScheduler.rangeHold;
            if (!$0O) {
                return null;
            }
            ;
            var $t = $e.rows[$0O.start.y];
            if (!$t) {
                return null;
            }
            ;
            var $0N = $t.Value;
            var $3N = $0O.end.x > $0O.start.x ? $0O.start.x : $0O.end.x;
            var $3O = ($0O.end.x > $0O.start.x ? $0O.end.x : $0O.start.x);
            var $1H = $t.Start.getTime() - this.$7K().getTime();
            var $v = this.itline[$3N].start.addTime($1H);
            var end = this.itline[$3O].end.addTime($1H);
            return new DayPilot.Selection($v, end, $0N, $e);
        };
        this.$8z = function ($17) {
            var $3P = $17.parentNode;
            var $3Q = document.createElement('textarea');
            $3Q.style.position = 'absolute';
            $3Q.style.width = (($17.offsetWidth < 100) ? 100 : ($17.offsetWidth - 2)) + 'px';
            $3Q.style.height = ($17.offsetHeight - 2) + 'px';
            $3Q.style.fontFamily = DayPilot.gs($17, 'fontFamily') || DayPilot.gs($17, 'font-family');
            $3Q.style.fontSize = DayPilot.gs($17, 'fontSize') || DayPilot.gs($17, 'font-size');
            $3Q.style.left = $17.offsetLeft + 'px';
            $3Q.style.top = $17.offsetTop + 'px';
            $3Q.style.border = '1px solid black';
            $3Q.style.padding = '0px';
            $3Q.style.marginTop = '0px';
            $3Q.style.backgroundColor = 'white';
            $3Q.value = DayPilot.tr($17.event.text());
            $3Q.event = $17.event;
            $3P.appendChild($3Q);
            return $3Q;
        };
        this.$69 = function ($17) {
            ...
            ;
            var $3Q = this.$8z($17);
            DayPilotScheduler.editing = $3Q;
            $3Q.onblur = function () {
                var $3R = $17.event.text();
                var $0P = $3Q.value;
                DayPilotScheduler.editing = null;
                if ($3Q.parentNode) {
                    $3Q.parentNode.removeChild($3Q);
                }
                ;
                if ($3R === $0P) {
                    return;
            ...
            $3Q.onkeypress = function (e) {
                var $3S = (window.event) ? event.keyCode : e.keyCode;
                if ($3S === 13) {
                    this.onblur();
                    return false;
                } else if ($3S === 27) {
        ...
        this.$7C = function (ev) {
            ...
            if (typeof(DayPilotBubble) !== 'undefined') {
                ...
                if ($e.resourceBubble) {
                    var $0W = {};
                    $0W.calendar = $e;
                    $0W.id = td.getAttribute("resource");
                    $0W.toJSON = function () {
                        var $0T = {};
                        $0T.id = this.id;
                        return $0T;
                    };
                    $e.resourceBubble.showResource($0W);
                }
            }
            ;
            var $B = td.firstChild;
        ...
        this.$8A = function () {
            ...
            ;
            var $3T = this.divNorth;
            DayPilot.puc($3T);
            $3T.innerHTML = '';
            $3T.appendChild($2Z);
            var $33 = this.$85();
            $3T.style.width = (this.$85() + 5000) + "px";
            var $3U = this.divCorner;
            if (!this.cssOnly) {
                $3U.style.backgroundColor = this.cornerBackColor;
            }
            ;
            if (this.cornerHtml) {
                $3U.innerHTML = this.cornerHtml;
            } else {
                $3U.innerHTML = '';
            }
            ;
            var $33 = this.$85();
            if ($33 > 0) {
                this.divStretch.style.width = (this.$85()) + "px";
            }
        };
        this.$5Z = function (h, $3V) {
            var $H = null;
            var $2t = this.$78.locale();
            var $3V = $3V || this.cellGroupBy;
            var $3W = h.start;
            var to = h.end;
            var $2t = this.$78.locale();
            switch ($3V) {
                case 'Hour':
                    ...
                    break;
                case 'Day':
                    $H = $3W.toString($2t.datePattern);
                    break;
                case 'Week':
                    $H = $04.weekStarts() === 1 ? $3W.weekNumberISO() : $3W.weekNumber();
                    break;
                case 'Month':
                    $H = $3W.toString("MMMM yyyy", $2t);
                    break;
                case 'Year':
                    $H = $3W.toString("yyyy");
                    break;
        ...
        this.$8C = function ($v, $0l) {
            var $2t = this.$78.locale();
            var $0l = $0l || this.cellDuration;
            if ($0l < 60) {
                return $v.toString("mm");
            } else if ($0l < 1440) {
                return $e.$78.timeFormat() === 'Clock12Hours' ? $v.toString("H tt", $2t) : $v.toString("H", $2t);
            } else if ($0l < 10080) {
                return $v.toString("d");
            } else if ($0l === 10080) {
                return $04.weekStarts() === 1 ? $v.weekNumberISO() : $v.weekNumber();
            } else {
                return $v.toString("MMMM yyyy", $2t);
            }
        };
        this.$5W = function ($3W) {
            var $3X = this.scale;
            switch ($3X) {
                ...
                case "Minute":
                    return $3W.addMinutes(1);
                case "CellDuration":
                    return $3W.addMinutes(this.cellDuration);
                default:
                    return this.$5Y($3W, $3X);
            }
        };
        this.$5Y = function ($3W, $3V) {
            var $3Y = this.viewType !== 'Days' ? this.days : 1;
            var $3Z = this.startDate.addDays($3Y);
            var $3V = $3V || this.cellGroupBy;
            var $05 = 60;
            switch ($3V) {
                case 'Hour':
                ...
                case 'Month':
                    ...
                    var $40 = (DayPilot.Date.diff(to.d, $3W.d) / (1000.0 * 60)) % $05 === 0;
                    while (!$40) {
                        to = to.addHours(1);
                        $40 = (DayPilot.Date.diff(to.d, $3W.d) / (1000.0 * 60)) % $05 === 0;
                    }
                    ;
                    break;
                case 'Year':
            ...
            ;
            if (to.getTime() > $3Z.getTime()) {
                to = $3Z;
            }
            ;
            return to;
        };
        this.$8B = function (x, y) {
            var $2Z = this.nav.timeHeader;
            var p = this.timeHeader[y][x];
            var $41 = y < this.timeHeader.length - 1;
            ...
            if (!this.cssOnly) {
                var $42 = y === this.timeHeader.length - 1;
            ...
            ;
            if (this.cssOnly) {
                var cl = this.$5L("_timeheadercol");
                var $43 = this.$5L("_timeheadercol_inner");
                if ($41) {
                    cl = this.$5L("_timeheadergroup");
                    $43 = this.$5L("_timeheadergroup_inner");
                }
                ;
                DayPilot.Util.addClass($z, cl);
                DayPilot.Util.addClass($E, $43);
            }
            ;
            $z.appendChild($E);
            this.$59.timeHeader[x + "_" + y] = $z;
            $2Z.appendChild($z);
        };
        this.$6m = function () {
            for (var i = 0; i < this.rows.length; i++) {
                var $t = this.rows[i];
                var $3k = $t.height() + $t.MarginBottom;
                if ($t.Height !== $3k) {
                    this.rowsDirty = true;
                }
                ;
        ...
        this.$5m = function () {
            var $2Z = this.divHeader;
            if (!$2Z) {
                return false;
            }
            ;
            var $1e = this.rows.length;
            var $13 = this.rowHeaderCols ? this.rowHeaderCols.length : 1;
            var j = 0;
            for (var i = 0; i < $1e; i++) {
                var $t = this.rows[i];
                if ($t.Hidden) {
                ...
                ;
                for (var c = 0; c < $2Z.rows[j].cells.length; c++) {
                    var $44 = $2Z.rows[j].cells[c];
                    var $45 = $t.Height;
                    if ($44 && $44.firstChild && parseInt($44.firstChild.style.height, 10) !== $45) {
                        $44.firstChild.style.height = $45 + "px";
                    }
                }
                ;
                j++;
        ...
        this.$8g = function ($1d) {
            ...
            var $47 = s.layer ? s.layer === 'AboveEvents' : false;
            ...
            ;
            if ($s.left > this.$5M() * this.cellWidth) {
                return;
            }
            ;
        ...
        this.$89 = function (ev) {
            ...
            if (!$e.coords) {
                var $3F = $e.maind;
                $e.coords = DayPilot.mo3($3F, ev);
            }
            ;
            ev = ev || window.event;
            if ($e.$8D($e.coords)) {
                var $3E = $e.$8x(DayPilotScheduler.rangeHold);
                $e.$6I($3E.start, $3E.end, $3E.resource);
            } else {
                DayPilotScheduler.range = $e.$8v();
                var $3E = $e.$8x(DayPilotScheduler.range);
                $e.$6I($3E.start, $3E.end, $3E.resource);
            }
            ;
        ...
        this.$8v = function () {
            var $0O = {};
            var cx = this.$61($e.coords.x).x;
            $0O.start = {y: $e.$70($e.coords.y).i, x: cx};
            $0O.end = {x: cx};
            if (this.$7m($e.$70($e.coords.y).i)) {
                return;
            }
            ;
            $0O.calendar = $e;
        ...
        this.$87 = function (ev) {
            ...
            ev = ev || window.event;
            var $48 = DayPilot.mc(ev);
            $e.coords = DayPilot.mo3($e.maind, ev);
            if ($0n.start) {
                if ($0n.originalMouse.x !== $48.x || $0n.originalMouse.y !== $48.y) {
            ...
            if (DayPilotScheduler.resizing) {
                if (!DayPilotScheduler.resizingShadow) {
                    DayPilotScheduler.resizingShadow = $e.$76(DayPilotScheduler.resizing, $e.shadow);
                }
                ;
                var $49 = DayPilotScheduler.resizing.event.calendar.cellWidth;
                var $4a = DayPilotScheduler.resizing.event.part.width;
                var $4b = DayPilotScheduler.resizing.event.part.left;
                var $4c = 0;
                var $4d = ($48.x - DayPilotScheduler.originalMouse.x);
                if (DayPilotScheduler.resizing.dpBorder === 'right') {
                    var $4e;
                    if ($e.snapToGrid) {
                        var $0i = $e.$61($4a + $4b + $4d).cell;
                        var $4f = $0i.left + $0i.width;
                        $4e = $4f - $4b;
                        if ($4e < $49) {
                            $4e = $49;
                        }
                    ...
                    ;
                    DayPilotScheduler.resizingShadow.style.width = ($4e) + 'px';
                } else if (DayPilotScheduler.resizing.dpBorder === 'left') {
                    var $4g;
                    if ($e.snapToGrid) {
                        $4g = Math.floor((($4b + $4d) + 0) / $49) * $49;
                        if ($4g < $4c) {
                            $4g = $4c;
                        }
                    } else {
                    ...
                    ;
                    DayPilotScheduler.resizingShadow.style.left = $4g + 'px';
                    DayPilotScheduler.resizingShadow.style.width = ($4e) + 'px';
                }
                ...
                var $0O = DayPilotScheduler.range;
                $0O.end = {x: $e.$61($e.coords.x).x};
                $e.$8w($0O);
            ...
            ;
            $e.$8F();
            var $4h = ev.insideEvent;
            if (window.event) {
                $4h = window.event.srcElement.insideEvent;
            }
            ;
            if ($e.cellBubble && $e.coords && $e.rows && $e.rows.length > 0 && !$4h) {
                var x = Math.floor($e.coords.x / $e.cellWidth);
                var y = $e.$70($e.coords.y).i;
                if (y < $e.rows.length) {
                    var $z = {};
                    $z.calendar = $e;
            ...
            if (DayPilotScheduler.drag) {
                ...
                if (!DayPilotScheduler.movingShadow && $e.coords && $e.rows.length > 0) {
                    if (!DayPilotScheduler.moving) {
                        ...
                        if (!event) {
                            var $4i = $e.itline[0].start;
                            $e.debug.message("external start:" + $4i);
                            var ev = {'id': DayPilotScheduler.drag.id, 'start': $4i, 'end': $4i.addSeconds(DayPilotScheduler.drag.duration), 'text': DayPilotScheduler.drag.text};
                    ...
                    ;
                    DayPilotScheduler.movingShadow = $e.$76(DayPilotScheduler.moving, DayPilotScheduler.drag.shadowType);
                }
                ;
                ev.cancelBubble = true;
            }
            ...
            if ($e.autoScroll === "Always" || ($e.autoScroll === "Drag" && (DayPilotScheduler.moving || DayPilotScheduler.resizing || DayPilotScheduler.range))) {
                var $4j = $e.nav.scroll;
                var $19 = {x: $e.coords.x, y: $e.coords.y};
                $19.x -= $4j.scrollLeft;
                $19.y -= $4j.scrollTop;
                var $V = $4j.clientWidth;
                var $P = $4j.clientHeight;
                var $24 = 20;
                var $x = $19.x < $24;
                var $y = $V - $19.x < $24;
                var top = $19.y < $24;
        ...
        this.$8F = function () {
            ...
            $z.start = $0i.start;
            $z.end = $0i.end;
            $z.resource = $t ? $t.data.Value : null;
            if (this.hover.cell) {
            ...
            if (typeof this.onCellMouseOver === 'function') {
                var $q = {};
                $q.cell = $z;
                this.onCellMouseOver($q);
            }
        };
        this.$84 = function () {
            if (typeof this.onCellMouseOut === 'function') {
                var $q = {};
                $q.cell = this.hover.cell;
                this.onCellMouseOut($q);
            }
            ;
        ...
        this.$8H = function () {
            ...
            ;
            var $4k = this.$8I(this.coords.x);
            if ($4k && this.crosshairLastX !== $4k.x) {
                if (this.crosshairTop && this.crosshairTop.parentNode) {
                    this.crosshairTop.parentNode.removeChild(this.crosshairTop);
                    this.crosshairTop = null;
                }
                ;
                var $03 = document.createElement("div");
                $03.style.width = $4k.cell.width + "px";
                ...
                var $3T = this.divNorth;
                var $4l = this.timeHeader ? this.timeHeader.length - 1 : 1;
                if (this.nav.timeHeader) {
                    this.$59.timeHeader[$4k.x + "_" + $4l].appendChild($03);
                } else {
                    if ($3T.firstChild.rows[$4l].cells[x]) {
                        $3T.firstChild.rows[$4l].cells[x].firstChild.appendChild($03);
                    }
                }
            }
            ;
            if (this.crosshairLastY !== y) {
                ...
                for (var i = 0; i < this.divHeader.rows[$t.i].cells.length; i++) {
                    var $V = this.divHeader.rows[$t.i].cells[i].clientWidth;
                    var $03 = document.createElement("div");
                    $03.style.width = $V + "px";
        ...
        this.$88 = function (ev) {
            ...
            if ($e.contextMenuSelection) {
                var $4m = $e.$8x(DayPilotScheduler.rangeHold);
                $e.contextMenuSelection.show($4m);
            }
            ;
            ev.cancelBubble = true;
        ...
        this.$8D = function ($19) {
            var $0O = DayPilotScheduler.rangeHold;
            if (!$0O || !$0O.start || !$0O.end) {
                return false;
            }
            ;
            var $t = this.$79($0O.start.y);
            var $4n = $0O.start.x < $0O.end.x;
            var $4o = ($4n ? $0O.start.x : $0O.end.x) * this.cellWidth;
            var $4p = ($4n ? $0O.end.x : $0O.start.x) * this.cellWidth + this.cellWidth;
            var $4q = $t.top;
            var $4r = $t.bottom;
            if ($19.x >= $4o && $19.x <= $4p && $19.y >= $4q && $19.y <= $4r) {
                return true;
            }
            ;
            return false;
        ...
        this.$8w = function ($0O) {
            var $0O = $0O || DayPilotScheduler.range;
            var $3N = $0O.end.x > $0O.start.x ? $0O.start.x : $0O.end.x;
            var $3O = ($0O.end.x > $0O.start.x ? $0O.end.x : $0O.start.x) + 1;
            this.$5w();
            for (var x = $3N; x < $3O; x++) {
                this.$8K(x, $0O.start.y);
            }
        };
        this.$8J = function (ev) {
            if ($e.timeRangeSelectedHandling === 'Disabled') {
            ...
            ;
            if (DayPilotScheduler.rangeHold && $e.$8D($e.coords) && ($3C === 3 || $3C === 2)) {
                return;
            }
            ;
            var $0O = {};
            ...
            var $3E = $e.$8x($0O);
            $e.$6H($3E.start, $3E.end, $3E.resource);
            DayPilotScheduler.rangeHold = $0O;
        };
        this.timeouts = {};
        ...
        this.$8f = function (ev) {
            ...
            ;
            var $4s = $e.nav.scroll;
            $e.scrollPos = $4s.scrollLeft;
            $e.scrollTop = $4s.scrollTop;
            $e.scrollWidth = $4s.clientWidth;
            ...
            ;
            $e.timeouts.drawEvents = setTimeout($e.$8M(), 200);
            $e.$5x();
            $e.$5s();
            $e.$5y();
        ...
        this.$8N = function () {
            return function () {
                $e.$5x();
                $e.$5s();
                $e.refreshTimeout = window.setTimeout($e.$8M(), 200);
            };
        };
        this.$8O = function () {
            return function () {
        ...
        this.$8M = function () {
            var $0J = true;
            var $4t = $e.dynamicEventRenderingCacheSweeping;
            var $4u = $e.dynamicEventRenderingCacheSize;
            return function () {
                if ($e.$8m()) {
                    $e.$6T();
                    window.setTimeout(function () {
        ...
        this.$5B = function () {
            this.$59.eventHeight = null;
            this.$59.drawArea = null;
        };
        this.show = function () {
        ...
        this.$8L = function () {
            ...
            $e.refreshTimeout = window.setTimeout($e.$8P($4s.scrollLeft, $4s.scrollTop), $I);
            $e.$5y();
        };
        this.$8Q = function (e) {
            for (var j = 0; j < this.events.list.length; j++) {
        ...
        this.$5v = function ($2a, $4x) {
            var $k = [];
            for (var i = 0; i < $2a.length; i++) {
                var e = $2a[i];
                var $0b = $e.$8Q(e);
                var $4y = $0b && $0b.modified;
                var $28 = !$0b;
                if ($4y) {
                    this.events.list[$0b.index] = e;
                    var $0A = $e.events.$6j($0b.ex);
                    $k = $k.concat($0A);
                } else if ($28) {
        ...
        this.$8P = function (scrollX, scrollY) {
            if (!$e.$5T()) {
                return function () {
                    if (typeof $e.onScroll === 'function') {
                        ...
                        var $u = $e.$6W(scrollX, scrollY);
                        var $0O = $e.$6X($u);
                        var $0W = $e.$6Y($u);
                        var $q = {};
                        $q.viewport = {};
                        $q.viewport.start = $0O.start;
                        $q.viewport.end = $0O.end;
                        $q.viewport.resources = $0W;
                        $q.async = false;
                        $q.events = [];
                        $q.loaded = function () {
                            if (this.async) {
        ...
        this.$8S = function () {
            var $u = this.$5G();
            var $4z = $u.xStart;
            var $4A = $u.xEnd - $u.xStart;
            var $4B = $u.yStart;
            var $4C = $u.yEnd - $u.yStart;
            if (!this.cellProperties) {
                this.cellProperties = [];
            }
            ;
        ...
        this.$5s = function () {
            ...
            this.maind.style.width = $V + "px";
            this.rowsDirty = false;
        };
        this.$8V = function () {
            var $u = this.$5G();
            for (var x = $u.xStart; x < $u.xEnd; x++) {
                var $4D = (x < this.itline.length - 1) ? this.itline[x + 1].breakBefore : false;
                if ($4D) {
                    this.$8W(x);
                }
            }
        ...
        this.$8W = function (x) {
            ...
            if (this.cssOnly) {
                $03.className = this.$5L("_matrix_vertical_break");
            } else {
            ...
            this.$59.breaks[$1d] = $03;
        };
        this.$5G = function () {
            if ($e.$59.drawArea) {
                return $e.$59.drawArea;
            }
            ;
            if (!this.nav.scroll) {
                return null;
            ...
            var $4F = $e.scrollTop;
            var $u = {};
            var $4G = Math.floor(this.scrollPos / this.cellWidth);
            var $4H = Math.ceil(this.scrollWidth / this.cellWidth) + 1;
            var $1X = this.$5M();
            var $v = $4G - $4E;
            var end = $v + 2 * $4E + $4H;
            end = Math.min(end, $1X);
            $v = Math.max($v, 0);
            var $4B = this.$70($4F).i;
            var $4I = this.$70($4F + this.nav.scroll.offsetHeight).i;
            if ($4I < this.rows.length) {
                $4I++;
            }
            ;
            var $4C = $4I - $4B;
        ...
        this.$8U = function (y) {
            ...
            $03.setAttribute("unselectable", "on");
            if (this.cssOnly) {
                $03.className = this.$5L("_matrix_horizontal_line");
            }
            ;
            this.divLines.appendChild($03);
            this.$59.linesHorizontal[$1d] = $03;
        };
        this.$8T = function (x) {
            var $0i = this.itline[x];
            if (!$0i) {
            ...
            $03.setAttribute("unselectable", "on");
            if (this.cssOnly) {
                $03.className = this.$5L("_matrix_vertical_line");
            }
            ;
            this.divLines.appendChild($03);
            this.elements.linesVertical.push($03);
            this.$59.linesVertical[$1d] = $03;
        };
        this.$8X = function (x) {
            var $1d = "x" + x;
            var $P = this.innerHeightTree;
            ...
            $z.style.height = $P + "px";
            $z.style.position = 'absolute';
            $z.style.backgroundColor = $46;
            $z.setAttribute("unselectable", "on");
            $z.className = this.cssOnly ? this.$5L('_cellcolumn') : this.$5L('cellbackground');
            $z.onclick = this.$8J;
        ...
        this.$7q = function ($1d) {
            var $t = this.rows[$1d];
            var $4J = !$t.Expanded;
            this.rows[$1d].Expanded = $4J;
            var $0A = this.$8Z($1d, $t.Expanded);
            if (!$4J) {
                for (var i = 0; i < $0A.length; i++) {
                    var ri = $0A[i];
                    this.$6A(ri);
        ...
        this.$7G = function (i) {
            ...
            if (typeof this.onLoadNode === 'function') {
                var $q = {};
                var $0N = this.rows[i].Resource;
                $q.resource = $0N;
                $q.async = false;
                $q.loaded = function () {
                    if (this.async) {
                        $0N.dynamicChildren = false;
                        $0N.expanded = true;
                        $e.update();
                    }
                };
        ...
        this.$8Z = function (i, $4K) {
            ...
            for (var k = 0; k < $t.Children.length; k++) {
                var $1d = $t.Children[k];
                this.rows[$1d].Hidden = $4K ? !$t.Expanded : true;
                if ($4K === !this.rows[$1d].Hidden) {
                    $4L.push($1d);
                }
                ;
                var $4M = this.$8Z($1d, $4K);
                if ($4M.length > 0) {
                    $4L = $4L.concat($4M);
                }
            }
        ...
        this.$92 = function ($39) {
            ...
            ;
            this.nav.scroll.scrollTop += $39;
            return true;
        };
        this.$90 = function ($4N, $4O) {
            var $4P = this.$91($4N) || this.$92($4O);
            if (!$4P) {
                return;
            }
            ;
            var $4Q = function ($4N, $4O) {
                return function () {
                    $e.$90($4N, $4O);
                };
            };
            this.scrolling = window.setTimeout($4Q($4N, $4O), 100);
        };
        this.$83 = function () {
            if (this.scrolling) {
        ...
        this.$7f = function (x, y) {
            ...
            if (typeof this.onBeforeCellRender === 'function') {
                var $t = $e.rows[y];
                var $0N = $t.Value;
                var $1H = $t.Start.getTime() - this.startDate.getTime();
                var $v = $0i.start.addTime($1H);
                var end = $0i.end.addTime($1H);
                var $z = this.cellProperties[$1d];
                if (!$z) {
                    $z = {};
                    var $4R = {};
                    $4R.start = $v;
            ...
            if (!this.drawBlankCells) {
                var $4T = false;
                if (this.cssOnly && this.$7n(y)) {
                    $4T = false;
                } else if (!this.$93(p, ['html', 'cssClass', 'backColor', 'backImage', 'backRepeat'])) {
                    $4T = true;
                }
                ;
                if ($4T) {
            ...
            ;
            $z.setAttribute("unselectable", "on");
            $z.className = this.cssOnly ? this.$5L('_cell') : this.$5L('cellbackground');
            $z.coords = {};
            $z.coords.x = x;
            $z.coords.y = y;
            if (this.cssOnly && this.$7n(y)) {
                DayPilot.Util.addClass($z, this.$5L("_cellparent"));
            }
            ;
            if (p) {
                if (p.cssClass) {
                    if (this.cssOnly) {
                        ...
                        DayPilot.Util.addClass($z, $e.$5L(p.cssClass));
                    }
                }
                ;
                if (p.html) {
                ...
                ;
                if (p.business) {
                    DayPilot.Util.addClass($z, $e.$5L("_cell_business"));
                }
            }
            ;
            $z.onclick = this.$8J;
        ...
        this.$93 = function ($17, $2S) {
            if ($2S) {
                for (var i = 0; i < $2S.length; i++) {
                    if ($17[$2S[i]]) {
                        return true;
                    }
                }
        ...
        $04.layout = function () {
            var $4U = /MSIE 6/i.test(navigator.userAgent);
            if ($e.layout === 'Auto') {
                if ($4U) {
                    return 'TableBased';
                } else {
        ...
        $04.useBox = function ($4V) {
            ...
            ;
            return $4V < $e.cellDuration * 60 * 1000;
        };
        $04.eventHeight = function () {
            if ($e.$59.eventHeight) {
                return $e.$59.eventHeight;
            }
            ;
            var $P = $e.$8b("_event_height").height;
            if (!$P) {
                $P = $e.eventHeight;
            }
            ;
        ...
        $04.headerHeight = function () {
            if ($e.$59.headerHeight) {
                return $e.$59.headerHeight;
            }
            ;
            var $P = $e.$8b("_header_height").height;
            if (!$P) {
                $P = $e.headerHeight;
            }
            ;
        ...
        this.$8Y = function (x, y) {
            var $1d = x + '_' + y;
            if (this.cellProperties && this.cellProperties[$1d]) {
                return this.cellProperties[$1d].backColor;
            }
            ;
            return null;
        };
        this.$7g = function (x, y) {
            var $1d = x + '_' + y;
            if (this.cellProperties && this.cellProperties[$1d]) {
                return this.cellProperties[$1d];
            }
            ;
            return null;
        };
        this.$94 = function ($4W, x, y) {
            var $1d = x + '_' + y;
            this.cellProperties[$1d] = {};
            DayPilot.Util.copyProps($4W, this.cellProperties[$1d], ['html', 'cssClass', 'backColor', 'backImage', 'backRepeat', 'business']);
            return this.cellProperties[$1d];
        };
        this.$95 = function (x, y) {
            if (!this.cellConfig) {
                return;
            }
            ;
            var $4X = this.cellConfig;
            if ($4X.vertical) {
        ...
        this.$5g = function () {
            ...
            var $4X = this.cellConfig;
            if ($4X.vertical) {
                for (var x = 0; x < $4X.x; x++) {
                    var $4Y = this.cellProperties[x + "_0"];
                    if (!$4Y) {
                        continue;
                    }
                    ;
                    for (var y = 1; y < $4X.y; y++) {
                        this.$94($4Y, x, y);
                    }
                }
            }
            ;
            if ($4X.horizontal) {
                for (var y = 0; y < $4X.y; y++) {
                    var $4Y = this.cellProperties["0_" + y];
                    if (!$4Y) {
                        continue;
                    }
                    ;
                    for (var x = 1; x < $4X.x; x++) {
                        this.$94($4Y, x, y);
                    }
                }
            }
        ...
        this.$98 = function ($s) {
            ...
            ;
            this.height = $s - (this.$5N() + 2);
            this.$5o();
        };
        this.setHeight = this.$98;
        this.$5D = function (id) {
            for (var i = 0; i < this.rows.length; i++) {
        ...
        this.init = function () {
            ...
            if (this.messageHTML) {
                ...
                window.setTimeout($51(this.messageHTML), 100);
            }
            ;
            this.$96();
            this.$5A();
        ...
        this.internal = {};
        this.internal.invokeEvent = this.$6g;
        this.internal.eventMenuClick = this.$6G;
        this.internal.timeRangeMenuClick = this.$6J;
        this.internal.resourceHeaderMenuClick = this.$6K;
        this.internal.bubbleCallBack = this.$6E;
        this.internal.findEventDiv = this.$8r;
        this.Init = this.init;
    };
    DayPilotScheduler.moving = null;
    ...
    DayPilotScheduler.dragStart = function (element, $0l, id, $25, $0w) {
        DayPilot.us(element);
        var $52 = DayPilotScheduler.drag = {};
        $52.element = element;
        $52.duration = $0l;
        $52.text = $25;
        $52.id = id;
        $52.shadowType = $0w ? $0w : 'Fill';
        return false;
    };
    ...
    DayPilotScheduler.gMouseMove = function (ev) {
        ...
        if (DayPilotScheduler.drag) {
            ...
            ;
            var $1a = DayPilotScheduler.gShadow;
            $1a.style.left = $48.x + 'px';
            $1a.style.top = $48.y + 'px';
            DayPilotScheduler.moving = null;
            if (DayPilotScheduler.movingShadow) {
                DayPilotScheduler.movingShadow.calendar = null;
                DayPilot.de(DayPilotScheduler.movingShadow);
            ...
            var $53 = DayPilotScheduler.moving.event.calendar;
            var ev = DayPilotScheduler.moving.event;
            DayPilotScheduler.moving.target = null;
            document.body.style.cursor = 'move';
            if (!DayPilotScheduler.gShadow) {
                DayPilotScheduler.gShadow = DayPilotScheduler.createGShadow($53.shadow);
            }
            ;
            var $1a = DayPilotScheduler.gShadow;
            $1a.style.left = $48.x + 'px';
            ...
            var $52 = DayPilotScheduler.drag;
            $52.element = null;
            $52.duration = (ev.end().getTime() - ev.start().getTime()) / 1000;
            $52.text = ev.text();
            $52.id = ev.value();
            $52.shadowType = $53.shadow;
            $52.event = ev;
            DayPilot.de(DayPilotScheduler.movingShadow);
            DayPilotScheduler.movingShadow.calendar = null;
            DayPilotScheduler.movingShadow = null;
        ...
        ;
        for (var i = 0; i < DayPilotScheduler.registered.length; i++) {
            if (DayPilotScheduler.registered[i].$7B) {
                DayPilotScheduler.registered[i].$7B();
            }
        }
    };
    ...
    DayPilotScheduler.gMouseUp = function (ev) {
        if (DayPilotScheduler.resizing) {
            ...
            var $e = e.calendar;
            var $54 = DayPilotScheduler.resizingShadow.clientWidth;
            var $55 = DayPilotScheduler.resizingShadow.offsetLeft;
            var $24 = DayPilotScheduler.resizing.dpBorder;
            var $t = $e.rows[DayPilotScheduler.resizing.event.part.dayIndex];
            var $1H = $t.Start.getTime() - $e.$7K().getTime();
            var $0u = null;
            var $0v = null;
            var $56 = !$e.snapToGrid;
            if ($24 === 'left') {
                $0u = $e.getDate($55, $56).addTime($1H);
                $0v = e.end();
            } else if ($24 === 'right') {
                $0u = e.start();
                $0v = $e.getDate($55 + $54, $56, true).addTime($1H);
            }
            ;
            ...
            DayPilotScheduler.movingShadow = null;
            var ev = ev || window.event;
            $e.$6D(e, $0u, $0v, $0x, external, ev, $03);
        } else if (DayPilotScheduler.range) {
            ev = ev || window.event;
            var $3C = ev.which || ev.button;
            var $0O = DayPilotScheduler.range;
            ...
            if ($e.timeRangeDoubleClickHandling === 'Disabled') {
                ...
                DayPilotScheduler.timeRangeTimeout = setTimeout($4Q($3E), $e.doubleClickTimeout);
            }
        }
        ;
        if (DayPilotScheduler.drag) {
    ...
    DayPilotScheduler.createGShadow = function ($0w) {
        ...
        $1a.setAttribute('unselectable', 'on');
        $1a.style.position = 'absolute';
        $1a.style.width = '100px';
        $1a.style.height = '20px';
        $1a.style.border = '2px dotted #666666';
        $1a.style.zIndex = 101;
        if ($0w === 'Fill') {
            $1a.style.backgroundColor = "#aaaaaa";
            $1a.style.opacity = 0.5;
            $1a.style.filter = "alpha(opacity=50)";
            $1a.style.border = '2px solid #aaaaaa';
        }
        ;
        document.body.appendChild($1a);
        return $1a;
    };
    ...
    if (typeof jQuery !== 'undefined') {
        (function ($) {
            $.fn.daypilotScheduler = function ($57) {
                var $4v = null;
                var j = this.each(function () {
                    if (this.daypilot) {
                        return;
                    ...
                    ;
                    var $58 = new DayPilot.Scheduler(this.id);
                    this.daypilot = $58;
                    for (var name in $57) {
                        $58[name] = $57[name];
                    }
