    ...
    Dates.view = function (elem, options) {
        ...
        if (!Dates.box) {
            ...
            div.innerHTML = log.html = '<div class="laydate_top">'
                ...
                + '<li><input maxlength="2" data-time="hover">:</li>'
                + '<li><input maxlength="2" data-time="minute">:</li>'
                + '<li><input maxlength="2" data-time="second"></li>'
                + '</ul>'
...
//事件
    Dates.events = function () {
        ...
        Dates.each(log.hmsin, function (i, elem) {
            Dates.on(elem, 'keyup', function (ev) {
                var value = elem.value;
                elem.value = value.replace(/[^0-9]/ig,'');
                if (elem.getAttribute("data-time") == "hover") {
                    if (elem.value > 23) {
                        elem.value = 23;
                    }
                } else if (elem.getAttribute("data-time") == "minute" || elem.getAttribute("data-time") == "second") {
                    if (elem.value > 59) {
                        elem.value = 59;
                    }
                }
                if (elem.value.length >= 2) {
                    Dates.reshow();
                    if (elem.getAttribute("data-time") == "hover" || elem.getAttribute("data-time") == "minute") {
                        elem.parentNode.nextSibling.firstChild.select();
                        elem.parentNode.nextSibling.firstChild.click();
                    }
                }
            });
            Dates.on(elem, 'click', function (ev) {
